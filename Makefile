...
VALID_TARGETS	 = ALIENWIIF1 ALIENWIIF3 CC3D CHEBUZZF3 CJMCU COLIBRI_RACE EUSTM32F103RC MOTOLAB NAZE NAZE32PRO OLIMEXINO PORT103R RMDO SPARKY SPRACINGF3 SPRACINGF3MINI STM32F3DISCOVERY EUSTM32F103VE
...
FLASH_SIZE = 256
else ifeq ($(TARGET),$(filter $(TARGET), EUSTM32F103VE))
FLASH_SIZE = 512
else
...
else ifeq ($(TARGET),$(filter $(TARGET),EUSTM32F103RC EUSTM32F103VE PORT103R))
...
EUSTM32F103VE_SRC = $(EUSTM32F103RC_SRC)
