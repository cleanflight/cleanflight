...
.LFB8:
	...
	.loc 1 101 0
	movl	$serialConfig_System, %eax	#, D.5592
	popq	%rbp	#
	.cfi_def_cfa 7, 8
	ret
	.cfi_endproc
...
.L7:
	...
	cltq
	movl	baudRates(,%rax,4), %eax	# baudRates, D.5595
	cmpl	-20(%rbp), %eax	# baudRate, D.5595
	jne	.L5	#,
	.loc 2 100 0
	movzbl	-1(%rbp), %eax	# index, D.5593
	jmp	.L6	#
.L5:
	.loc 2 98 0 discriminator 2
	movzbl	-1(%rbp), %eax	# index, D.5596
	addl	$1, %eax	#, tmp93
...
.LBB2:
	...
	movl	(%rax), %eax	# candidate_5->identifier, D.5599
	cmpl	-20(%rbp), %eax	# identifier, D.5599
	jne	.L10	#,
	.loc 2 112 0
	movq	-8(%rbp), %rax	# candidate, D.5597
	jmp	.L11	#
.L10:
.LBE2:
...
.LBB3:
	...
	.loc 2 123 0
	movq	-8(%rbp), %rax	# candidate, tmp96
	movq	8(%rax), %rax	# candidate_5->serialPort, D.5603
	cmpq	-24(%rbp), %rax	# serialPort, D.5603
	jne	.L15	#,
	.loc 2 124 0
	movq	-8(%rbp), %rax	# candidate, D.5601
	jmp	.L16	#
.L15:
.LBE3:
	.loc 2 121 0 discriminator 2
	movzbl	-9(%rbp), %eax	# index, D.5604
	addl	$1, %eax	#, tmp97
	movb	%al, -9(%rbp)	# tmp97, index
.L14:
...
.LBB4:
	...
	call	serialConfig	#
	movq	%rax, %rcx	#, D.5609
	movzbl	findSerialPortConfigState(%rip), %eax	# findSerialPortConfigState.lastIndex, D.5608
	leal	1(%rax), %edx	#, D.5608
	movb	%dl, findSerialPortConfigState(%rip)	# D.5608, findSerialPortConfigState.lastIndex
	movzbl	%al, %eax	# D.5608, D.5610
	movslq	%eax, %rdx	# D.5610, tmp97
	movq	%rdx, %rax	# tmp97, tmp98
	addq	%rax, %rax	# tmp98
	addq	%rdx, %rax	# tmp97, tmp98
	salq	$2, %rax	#, tmp99
	addq	%rcx, %rax	# D.5609, tmp100
	addq	$4, %rax	#, tmp101
	movq	%rax, -8(%rbp)	# tmp101, candidate
	.loc 2 147 0
	movq	-8(%rbp), %rax	# candidate, tmp102
	movzwl	4(%rax), %eax	# candidate_13->functionMask, D.5611
	andw	-20(%rbp), %ax	# mask, D.5611
	testw	%ax, %ax	# D.5611
	je	.L21	#,
	.loc 2 148 0
	movq	-8(%rbp), %rax	# candidate, D.5607
	jmp	.L22	#
.L21:
.LBE4:
	.loc 2 145 0
...
.LFB14:
	...
	movzwl	4(%rax), %eax	# portConfig_3(D)->functionMask, D.5613
	movzwl	%ax, %eax	# D.5613, D.5614
	andl	-12(%rbp), %eax	# function, D.5614
	testl	%eax, %eax	# D.5614
	jne	.L26	#,
.L25:
...
.L26:
	...
	movzwl	4(%rax), %eax	# portConfig_3(D)->functionMask, D.5613
	movzwl	%ax, %eax	# D.5613, D.5614
	cmpl	-12(%rbp), %eax	# function, D.5614
	jne	.L28	#,
...
.LFB15:
	...
	movzwl	4(%rax), %eax	# portConfig_2(D)->functionMask, D.5616
	movzwl	%ax, %eax	# D.5616, D.5617
	andl	-16(%rbp), %eax	# sharedWithFunction, D.5617
	testl	%eax, %eax	# D.5617
	je	.L31	#,
	.loc 2 168 0 discriminator 3
	movq	-8(%rbp), %rax	# portConfig, tmp97
	movzwl	4(%rax), %eax	# portConfig_2(D)->functionMask, D.5616
	andw	-12(%rbp), %ax	# functionMask, D.5616
	testw	%ax, %ax	# D.5616
	je	.L31	#,
...
.LFB16:
	...
	movl	(%rax), %eax	# portConfig_4(D)->identifier, D.5620
	movl	%eax, %edi	# D.5620,
	...
	movl	16(%rax), %eax	# serialPortUsage_7->function, D.5621
	testl	%eax, %eax	# D.5621
	je	.L35	#,
...
.LFB17:
	...
	call	memset	#
	.loc 2 185 0
	movzwl	-4(%rbp), %eax	# functionMask, D.5624
...
.LBB5:
	...
	call	serialConfig	#
	movq	%rax, %rcx	#, D.5628
	movzbl	findSharedSerialPortState(%rip), %eax	# findSharedSerialPortState.lastIndex, D.5627
	leal	1(%rax), %edx	#, D.5627
	movb	%dl, findSharedSerialPortState(%rip)	# D.5627, findSharedSerialPortState.lastIndex
	movzbl	%al, %eax	# D.5627, D.5629
	movslq	%eax, %rdx	# D.5629, tmp98
	movq	%rdx, %rax	# tmp98, tmp99
	addq	%rax, %rax	# tmp99
	addq	%rdx, %rax	# tmp98, tmp99
	salq	$2, %rax	#, tmp100
	addq	%rcx, %rax	# D.5628, tmp101
	addq	$4, %rax	#, tmp102
	movq	%rax, -16(%rbp)	# tmp102, candidate
	.loc 2 193 0
	movzwl	-20(%rbp), %ecx	# functionMask, D.5629
...
.LBB6:
	...
	movl	(%rax), %eax	# candidate_13->identifier, D.5631
	movl	%eax, %edi	# D.5631,
	call	findSerialPortUsageByIdentifier	#
...
.L42:
	...
	movq	8(%rax), %rax	# serialPortUsage_21->serialPort, D.5626
	jmp	.L43	#
.L41:
.LBE6:
.LBE5:
...
.LBB7:
	.loc 2 220 0
	movzbl	-10(%rbp), %eax	# index, D.5633
	movslq	%eax, %rdx	# D.5633, tmp139
	...
	movzwl	4(%rax), %eax	# portConfig_9->functionMask, D.5634
	movzwl	%ax, %eax	# D.5634, D.5633
	andl	$513, %eax	#, D.5633
	testl	%eax, %eax	# D.5633
	je	.L47	#,
	.loc 2 223 0
	movzbl	-11(%rbp), %eax	# mspPortCount, D.5635
	addl	$1, %eax	#, tmp146
...
.L47:
	...
	movzwl	4(%rax), %eax	# portConfig_9->functionMask, D.5634
	movzwl	%ax, %edx	# D.5634, D.5633
	movq	-8(%rbp), %rax	# portConfig, tmp148
	movzwl	4(%rax), %eax	# portConfig_9->functionMask, D.5634
	shrw	%ax	# D.5634
	movzwl	%ax, %eax	# D.5634, D.5633
	andl	$2004318071, %eax	#, D.5633
	subl	%eax, %edx	# D.5633, D.5633
	movq	-8(%rbp), %rax	# portConfig, tmp149
	movzwl	4(%rax), %eax	# portConfig_9->functionMask, D.5634
	shrw	$2, %ax	#, D.5634
	movzwl	%ax, %eax	# D.5634, D.5633
	andl	$858993459, %eax	#, D.5633
	subl	%eax, %edx	# D.5633, D.5633
	movq	-8(%rbp), %rax	# portConfig, tmp150
	movzwl	4(%rax), %eax	# portConfig_9->functionMask, D.5634
	shrw	$3, %ax	#, D.5634
	movzwl	%ax, %eax	# D.5634, D.5633
	andl	$286331153, %eax	#, D.5633
	movl	%edx, %ecx	# D.5633, D.5633
	subl	%eax, %ecx	# D.5633, D.5633
	...
	andl	$286331153, %eax	#, D.5633
	subl	%eax, %edx	# D.5633, D.5633
	movl	%edx, %eax	# D.5633, D.5633
	sarl	$4, %eax	#, D.5633
	addl	%ecx, %eax	# D.5633, D.5633
	andl	$252645135, %eax	#, D.5633
	movl	%eax, %edx	# D.5633, D.5633
	movslq	%edx, %rax	# D.5633, tmp155
	imulq	$-2139062143, %rax, %rax	#, tmp155, tmp156
	shrq	$32, %rax	#, tmp157
	addl	%edx, %eax	# D.5633, tmp158
	sarl	$7, %eax	#, tmp159
	movl	%eax, %ecx	# tmp159, tmp159
	movl	%edx, %eax	# D.5633, tmp160
	sarl	$31, %eax	#, tmp160
	subl	%eax, %ecx	# tmp160, D.5633
	movl	%ecx, %eax	# D.5633, D.5633
	movl	%eax, %ecx	# D.5633, tmp161
	sall	$8, %ecx	#, tmp162
	subl	%eax, %ecx	# D.5633, tmp161
	movl	%edx, %eax	# D.5633, D.5633
	subl	%ecx, %eax	# tmp161, D.5633
	movb	%al, -9(%rbp)	# D.5633, bitCount
	.loc 2 227 0
...
.LBE7:
	...
	movzbl	-10(%rbp), %eax	# index, D.5635
	addl	$1, %eax	#, tmp165
...
.LBB8:
	...
	call	serialConfig	#
	movq	%rax, %rcx	#, D.5637
	movzbl	-9(%rbp), %eax	# index, D.5638
	movslq	%eax, %rdx	# D.5638, tmp93
	movq	%rdx, %rax	# tmp93, tmp94
	addq	%rax, %rax	# tmp94
	addq	%rdx, %rax	# tmp93, tmp94
	salq	$2, %rax	#, tmp95
	addq	%rcx, %rax	# D.5637, tmp96
	addq	$4, %rax	#, tmp97
	movq	%rax, -8(%rbp)	# tmp97, candidate
	.loc 2 255 0
	movq	-8(%rbp), %rax	# candidate, tmp98
	movl	(%rax), %eax	# candidate_10->identifier, D.5639
	cmpl	-20(%rbp), %eax	# identifier, D.5639
	jne	.L57	#,
	.loc 2 256 0
	movq	-8(%rbp), %rax	# candidate, D.5636
	jmp	.L58	#
.L57:
.LBE8:
	.loc 2 253 0 discriminator 2
	movzbl	-9(%rbp), %eax	# index, D.5640
	addl	$1, %eax	#, tmp99
...
.LFB21:
	...
	movzwl	4(%rax), %eax	# candidate_5->functionMask, D.5642
	testw	%ax, %ax	# D.5642
	je	.L61	#,
...
.LFB22:
	...
	movl	16(%rax), %eax	# serialPortUsage_8->function, D.5645
	testl	%eax, %eax	# D.5645
	je	.L66	#,
.L65:
...
.L71:
	...
	movl	%eax, %edx	# tmp96, D.5646
	movq	-16(%rbp), %rax	# serialPort, tmp97
	movb	%dl, 8(%rax)	# D.5646, serialPort_1->identifier
	.loc 2 344 0
	...
	.loc 2 347 0
	movq	-16(%rbp), %rax	# serialPort, D.5644
.L67:
	.loc 2 349 0
	leave
	.cfi_def_cfa 7, 8
...
.L78:
	.loc 2 375 0
	movzbl	-1(%rbp), %edx	# index, D.5647
	movzbl	-1(%rbp), %eax	# index, D.5647
	cltq
	movl	serialPortIdentifiers(,%rax,4), %ecx	# serialPortIdentifiers, D.5648
	movslq	%edx, %rdx	# D.5647, tmp94
	movq	%rdx, %rax	# tmp94, tmp96
	addq	%rax, %rax	# tmp96
	addq	%rdx, %rax	# tmp94, tmp96
	salq	$3, %rax	#, tmp97
	addq	$serialPortUsageList, %rax	#, tmp98
	movl	%ecx, (%rax)	# D.5648, serialPortUsageList[_7].identifier
	.loc 2 374 0
...
.L82:
	.loc 2 397 0
	movzbl	-1(%rbp), %eax	# index, D.5651
	movslq	%eax, %rdx	# D.5651, tmp93
	movq	%rdx, %rax	# tmp93, tmp95
	addq	%rax, %rax	# tmp95
	addq	%rdx, %rax	# tmp93, tmp95
	salq	$3, %rax	#, tmp96
	addq	$serialPortUsageList, %rax	#, tmp97
	movl	(%rax), %eax	# serialPortUsageList[_6].identifier, D.5652
	cmpl	-20(%rbp), %eax	# identifier, D.5652
	jne	.L81	#,
	.loc 2 398 0
	movzbl	-1(%rbp), %eax	# index, D.5651
	movslq	%eax, %rdx	# D.5651, tmp98
	...
	.loc 2 399 0
	movzbl	serialPortCount(%rip), %eax	# serialPortCount, D.5653
	subl	$1, %eax	#, D.5653
	movb	%al, serialPortCount(%rip)	# D.5653, serialPortCount
.L81:
...
.LFB26:
	...
	.cfi_def_cfa_register 6
	.loc 2 406 0
	movzbl	serialPortCount(%rip), %eax	# serialPortCount, D.5654
	.loc 2 407 0
	popq	%rbp	#
	.cfi_def_cfa 7, 8
	ret
...
.L89:
	.loc 2 412 0
	movzbl	-1(%rbp), %eax	# index, D.5656
	movslq	%eax, %rdx	# D.5656, tmp92
	movq	%rdx, %rax	# tmp92, tmp94
	addq	%rax, %rax	# tmp94
	addq	%rdx, %rax	# tmp92, tmp94
	salq	$3, %rax	#, tmp95
	addq	$serialPortUsageList, %rax	#, tmp96
	movl	(%rax), %eax	# serialPortUsageList[_4].identifier, D.5657
	cmpl	-20(%rbp), %eax	# identifier, D.5657
	jne	.L87	#,
	.loc 2 413 0
	movl	$1, %eax	#, D.5655
	jmp	.L88	#
