...
const gyroConfig_t pgResetTemplate_gyroConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .gyro_lpf = 0, .soft_gyro_lpf_hz = 100, .gyroMovementCalibrationThreshold = 32, }
...
static void initGyroFilterCoefficients(void)
{
    if (gyroConfig()->soft_gyro_lpf_hz) {
        ...
        gyroFilterStateIsSet = 
# 75 "src/main/sensors/gyro.c" 3 4
                              1
# 75 "src/main/sensors/gyro.c"
                                  ;
    }
}
...
# 84 "src/main/sensors/gyro.c" 3 4
_Bool 
# 84 "src/main/sensors/gyro.c"
    isGyroCalibrationComplete(void)
{
