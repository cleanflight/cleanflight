...
# 46 "src/main/drivers/serial_uart.h"
...
# 70 "src/main/drivers/serial_uart.h" 3 4
   _Bool 
# 70 "src/main/drivers/serial_uart.h"
        buffering;
} uartPort_t;
...
# 86 "src/main/drivers/serial_uart.h" 3 4
_Bool 
# 86 "src/main/drivers/serial_uart.h"
...
static const struct serialPortVTable usbTable[] = {
    {
        ...
        .beginWrite = 
# 81 "src/main/drivers/serial_uart.c" 3 4
                     ((void *)0)
# 81 "src/main/drivers/serial_uart.c"
                         ,
        .endWrite = 
...
# 82 "src/main/drivers/serial_uart.c"
                       ,
        .writeBuf = 
# 83 "src/main/drivers/serial_uart.c" 3 4
                   ((void *)0)
    
# 84 "src/main/drivers/serial_uart.c"
   }
};
...
serialPort_t* usbInit(void)
{
    ...
    tcflush(fd,
# 102 "src/main/drivers/serial_uart.c" 3 4
              2
# 102 "src/main/drivers/serial_uart.c"
                       );
    SetUsbAttributes(fd);
    return &USB.port;
}
...
# 112 "src/main/drivers/serial_uart.c" 3 4
                                                           (*__errno_location ())
# 112 "src/main/drivers/serial_uart.c"
                                                                ));
        exit(
# 113 "src/main/drivers/serial_uart.c" 3 4
            1
# 113 "src/main/drivers/serial_uart.c"
                        );
    }
    USB.fd = fd;
...
# 126 "src/main/drivers/serial_uart.c"
        ...
        exit(
# 127 "src/main/drivers/serial_uart.c" 3 4
            1
# 127 "src/main/drivers/serial_uart.c"
                        );
    }
    ...
    tty.c_cflag |= (
# 136 "src/main/drivers/serial_uart.c" 3 4
                   0004000 
# 136 "src/main/drivers/serial_uart.c"
                          | 
# 136 "src/main/drivers/serial_uart.c" 3 4
                            0000200
# 136 "src/main/drivers/serial_uart.c"
    ...
    tty.c_cflag &= ~
# 137 "src/main/drivers/serial_uart.c" 3 4
                   0000060
# 137 "src/main/drivers/serial_uart.c"
                        ;
    tty.c_cflag |= 
# 138 "src/main/drivers/serial_uart.c" 3 4
                  0000060
# 138 "src/main/drivers/serial_uart.c"
                     ;
    tty.c_cflag &= ~
# 139 "src/main/drivers/serial_uart.c" 3 4
                   0000400
# 139 "src/main/drivers/serial_uart.c"
                         ;
    tty.c_cflag &= ~
# 140 "src/main/drivers/serial_uart.c" 3 4
                   0000100
# 140 "src/main/drivers/serial_uart.c"
                         ;
    tty.c_cflag &= ~
# 141 "src/main/drivers/serial_uart.c" 3 4
                   020000000000
# 141 "src/main/drivers/serial_uart.c"
                          ;

    if (tcsetattr(fd, 
# 143 "src/main/drivers/serial_uart.c" 3 4
                     0
# 143 "src/main/drivers/serial_uart.c"
                            , &tty) != 0) {
...
uint32_t usbWrite(uint8_t* str, int len)
{
    ...
    if(usbIsConnected() == 
# 155 "src/main/drivers/serial_uart.c" 3 4
                          0
# 155 "src/main/drivers/serial_uart.c"
                               )
    {
...
# 170 "src/main/drivers/serial_uart.c" 3 4
   ((void) (((
# 170 "src/main/drivers/serial_uart.c"
   &readset
# 170 "src/main/drivers/serial_uart.c" 3 4
   )->__fds_bits)[((
# 170 "src/main/drivers/serial_uart.c"
...
# 177 "src/main/drivers/serial_uart.c" 3 4
           do { int __d0, __d1; __asm__ __volatile__ ("cld; rep; " "stosq" : "=c" (__d0), "=D" (__d1) : "a" (0), "0" (sizeof (fd_set) / sizeof (__fd_mask)), "1" (&((
# 177 "src/main/drivers/serial_uart.c"
           &readset
# 177 "src/main/drivers/serial_uart.c" 3 4
           )->__fds_bits)[0]) : "memory"); } while (0)
# 177 "src/main/drivers/serial_uart.c"
...
# 178 "src/main/drivers/serial_uart.c" 3 4
           ((void) (((
...
uint8_t usbIsConnected(void)
{
    if(USB.deviceState != UNCONNECTED)
        return 
# 200 "src/main/drivers/serial_uart.c" 3 4
              1
# 200 "src/main/drivers/serial_uart.c"
                  ;
    else
        return 
# 202 "src/main/drivers/serial_uart.c" 3 4
              0
# 202 "src/main/drivers/serial_uart.c"
                   ;
}
...
# 221 "src/main/drivers/serial_uart.c" 3 4
_Bool 
# 221 "src/main/drivers/serial_uart.c"
    usb_txbuffer_empty(serialPort_t *instance)
{
    return 
# 223 "src/main/drivers/serial_uart.c" 3 4
          1
# 223 "src/main/drivers/serial_uart.c"
              ;
}
...
# 235 "src/main/drivers/serial_uart.c" 3 4
   do { int __d0, __d1; __asm__ __volatile__ ("cld; rep; " "stosq" : "=c" (__d0), "=D" (__d1) : "a" (0), "0" (sizeof (fd_set) / sizeof (__fd_mask)), "1" (&((
# 235 "src/main/drivers/serial_uart.c"
   &readset
# 235 "src/main/drivers/serial_uart.c" 3 4
   )->__fds_bits)[0]) : "memory"); } while (0)
# 235 "src/main/drivers/serial_uart.c"
...
# 236 "src/main/drivers/serial_uart.c" 3 4
   ((void) (((
# 236 "src/main/drivers/serial_uart.c"
   &readset
# 236 "src/main/drivers/serial_uart.c" 3 4
   )->__fds_bits)[((
# 236 "src/main/drivers/serial_uart.c"
...
# 241 "src/main/drivers/serial_uart.c" 3 4
                                         ((void *)0)
# 241 "src/main/drivers/serial_uart.c"
                                             , 
# 241 "src/main/drivers/serial_uart.c" 3 4
                                               ((void *)0)
# 241 "src/main/drivers/serial_uart.c"
