...
# 59 "src/main/drivers/serial_uart.h"
...
void usartInitAllIOSignals(void)
{
    ...
    usbInit();
# 70 "src/main/drivers/serial_uart.c"
}
...
# 77 "src/main/drivers/serial_uart.c" 3 4
                           02 
# 77 "src/main/drivers/serial_uart.c"
                                  | 
# 77 "src/main/drivers/serial_uart.c" 3 4
                                    0400 
# 77 "src/main/drivers/serial_uart.c"
...
# 79 "src/main/drivers/serial_uart.c" 3 4
                                                           (*__errno_location ())
# 79 "src/main/drivers/serial_uart.c"
                                                                ));
        exit(
# 80 "src/main/drivers/serial_uart.c" 3 4
            1
# 80 "src/main/drivers/serial_uart.c"
                        );
    }
...
# 83 "src/main/drivers/serial_uart.c" 3 4
                                                     (*__errno_location ())
# 83 "src/main/drivers/serial_uart.c"
                                                          ));
        exit(
...
# 84 "src/main/drivers/serial_uart.c"
    ...
    tty.c_cflag |= (
# 93 "src/main/drivers/serial_uart.c" 3 4
                   0004000 
# 93 "src/main/drivers/serial_uart.c"
                          | 
# 93 "src/main/drivers/serial_uart.c" 3 4
                            0000200
# 93 "src/main/drivers/serial_uart.c"
    ...
    tty.c_cflag &= ~
# 94 "src/main/drivers/serial_uart.c" 3 4
                   0000060
# 94 "src/main/drivers/serial_uart.c"
                        ;
    tty.c_cflag |= 
# 95 "src/main/drivers/serial_uart.c" 3 4
                  0000060
# 95 "src/main/drivers/serial_uart.c"
                     ;
    tty.c_cflag &= ~
# 96 "src/main/drivers/serial_uart.c" 3 4
                   0000400
# 96 "src/main/drivers/serial_uart.c"
                         ;
    tty.c_cflag &= ~
# 97 "src/main/drivers/serial_uart.c" 3 4
                   0000100
