...
# 1 "/usr/include/errno.h" 1 3 4
# 3 "./src/main/includes.h" 2
# 20 "src/main/drivers/serial_uart.h" 2
...
# 41 "src/main/drivers/serial_uart.h"
...
# 65 "src/main/drivers/serial_uart.h" 3 4
   _Bool 
# 65 "src/main/drivers/serial_uart.h"
        buffering;
} uartPort_t;
...
# 81 "src/main/drivers/serial_uart.h" 3 4
_Bool 
# 81 "src/main/drivers/serial_uart.h"
...
# 46 "src/main/drivers/serial_uart.c"
uartPort_t USB;
...
# 81 "src/main/drivers/serial_uart.c"
                         )
        {
            ...
            return 
# 84 "src/main/drivers/serial_uart.c" 3 4
                  1
...
# 119 "src/main/drivers/serial_uart.c"
    ...
    tty.c_cflag |= (
# 128 "src/main/drivers/serial_uart.c" 3 4
                   0004000 
# 128 "src/main/drivers/serial_uart.c"
                          | 
# 128 "src/main/drivers/serial_uart.c" 3 4
                            0000200
# 128 "src/main/drivers/serial_uart.c"
    ...
    tty.c_cflag &= ~
# 129 "src/main/drivers/serial_uart.c" 3 4
                   0000060
# 129 "src/main/drivers/serial_uart.c"
                        ;
    tty.c_cflag |= 
# 130 "src/main/drivers/serial_uart.c" 3 4
                  0000060
# 130 "src/main/drivers/serial_uart.c"
                     ;
    tty.c_cflag &= ~
# 131 "src/main/drivers/serial_uart.c" 3 4
                   0000400
# 131 "src/main/drivers/serial_uart.c"
                         ;
    tty.c_cflag &= ~
# 132 "src/main/drivers/serial_uart.c" 3 4
                   0000100
# 132 "src/main/drivers/serial_uart.c"
                         ;
    tty.c_cflag &= ~
...
# 153 "src/main/drivers/serial_uart.c"
        ...
        exit(
# 154 "src/main/drivers/serial_uart.c" 3 4
            1
# 154 "src/main/drivers/serial_uart.c"
                        );
    }
...
# 165 "src/main/drivers/serial_uart.c" 3 4
   ((void) (((
# 165 "src/main/drivers/serial_uart.c"
   &readset
# 165 "src/main/drivers/serial_uart.c" 3 4
   )->__fds_bits)[((
# 165 "src/main/drivers/serial_uart.c"
...
# 172 "src/main/drivers/serial_uart.c" 3 4
           do { int __d0, __d1; __asm__ __volatile__ ("cld; rep; " "stosq" : "=c" (__d0), "=D" (__d1) : "a" (0), "0" (sizeof (fd_set) / sizeof (__fd_mask)), "1" (&((
# 172 "src/main/drivers/serial_uart.c"
           &readset
# 172 "src/main/drivers/serial_uart.c" 3 4
           )->__fds_bits)[0]) : "memory"); } while (0)
# 172 "src/main/drivers/serial_uart.c"
...
# 173 "src/main/drivers/serial_uart.c" 3 4
           ((void) (((
# 173 "src/main/drivers/serial_uart.c"
           &readset
# 173 "src/main/drivers/serial_uart.c" 3 4
           )->__fds_bits)[((
# 173 "src/main/drivers/serial_uart.c"
...
# 217 "src/main/drivers/serial_uart.c" 3 4
_Bool 
# 217 "src/main/drivers/serial_uart.c"
    usb_txbuffer_empty(serialPort_t *instance)
{
    return 
# 219 "src/main/drivers/serial_uart.c" 3 4
          1
# 219 "src/main/drivers/serial_uart.c"
              ;
}
...
# 230 "src/main/drivers/serial_uart.c" 3 4
   do { int __d0, __d1; __asm__ __volatile__ ("cld; rep; " "stosq" : "=c" (__d0), "=D" (__d1) : "a" (0), "0" (sizeof (fd_set) / sizeof (__fd_mask)), "1" (&((
...
# 231 "src/main/drivers/serial_uart.c" 3 4
   ((void) (((
# 231 "src/main/drivers/serial_uart.c"
   &readset
# 231 "src/main/drivers/serial_uart.c" 3 4
   )->__fds_bits)[((
# 231 "src/main/drivers/serial_uart.c"
...
# 231 "src/main/drivers/serial_uart.c"
    ...
    uint32_t result;
    result = select(USB.fd + 1, &readset, 
# 233 "src/main/drivers/serial_uart.c" 3 4
                                         ((void *)0)
# 233 "src/main/drivers/serial_uart.c"
                                             , 
# 233 "src/main/drivers/serial_uart.c" 3 4
                                               ((void *)0)
# 233 "src/main/drivers/serial_uart.c"
