...
# 88 "src/main/drivers/serial_uart.c"
}
...
# 168 "src/main/drivers/serial_uart.c" 3 4
                                             ((void *)0)
# 168 "src/main/drivers/serial_uart.c"
                                                 , 
# 168 "src/main/drivers/serial_uart.c" 3 4
                                                   ((void *)0)
# 168 "src/main/drivers/serial_uart.c"
...
# 171 "src/main/drivers/serial_uart.c" 3 4
           do { int __d0, __d1; __asm__ __volatile__ ("cld; rep; " "stosq" : "=c" (__d0), "=D" (__d1) : "a" (0), "0" (sizeof (fd_set) / sizeof (__fd_mask)), "1" (&((
# 171 "src/main/drivers/serial_uart.c"
           &readset
# 171 "src/main/drivers/serial_uart.c" 3 4
           )->__fds_bits)[0]) : "memory"); } while (0)
# 171 "src/main/drivers/serial_uart.c"
...
{
    return 
# 218 "src/main/drivers/serial_uart.c" 3 4
          1
# 218 "src/main/drivers/serial_uart.c"
              ;
}
