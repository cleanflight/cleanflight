...
# 1 "src/main/drivers/../includes.h" 1
...
# 2 "src/main/drivers/../includes.h" 2
...
# 3 "src/main/drivers/../includes.h" 2
...
# 7 "src/main/drivers/../includes.h" 2
...
# 8 "src/main/drivers/../includes.h" 2
...
# 37 "src/main/drivers/serial_uart.h"
typedef struct {
...
# 77 "src/main/drivers/serial_uart.h" 3 4
_Bool 
# 77 "src/main/drivers/serial_uart.h"
    usbIsConnected(void);
# 31 "src/main/drivers/serial_uart.c" 2
# 44 "src/main/drivers/serial_uart.c"
...
# 87 "src/main/drivers/serial_uart.c" 3 4
                                                           (*__errno_location ())
# 87 "src/main/drivers/serial_uart.c"
                                                                ));
        exit(
# 88 "src/main/drivers/serial_uart.c" 3 4
            1
...
# 100 "src/main/drivers/serial_uart.c" 3 4
                                                     (*__errno_location ())
# 100 "src/main/drivers/serial_uart.c"
                                                          ));
        exit(
...
# 113 "src/main/drivers/serial_uart.c"
                         ;
    tty.c_cflag &= ~
# 114 "src/main/drivers/serial_uart.c" 3 4
                   0000100
# 114 "src/main/drivers/serial_uart.c"
                         ;
    tty.c_cflag &= ~
# 115 "src/main/drivers/serial_uart.c" 3 4
                   020000000000
# 115 "src/main/drivers/serial_uart.c"
                          ;

    if (tcsetattr(fd, 
# 117 "src/main/drivers/serial_uart.c" 3 4
                     0
# 117 "src/main/drivers/serial_uart.c"
                            , &tty) != 0) {
...
# 148 "src/main/drivers/serial_uart.c"
        ...
        return 
# 150 "src/main/drivers/serial_uart.c" 3 4
              0
# 150 "src/main/drivers/serial_uart.c"
                   ;
}
