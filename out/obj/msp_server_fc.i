...
# 21 "./src/main/fc/msp_server_fc.h" 3 4
_Bool 
# 21 "./src/main/fc/msp_server_fc.h"
    sensors(uint32_t mask){ return enabledSensors & mask; }
...
# 416 "src/main/fc/msp_server_fc.c"
...
int mspServerCommandHandler(mspPacket_t *cmd, mspPacket_t *reply)
{
    ...
    switch (cmd->cmd) {
        ...
        default:
            printf("Unknown\n");
            break;
# 1532 "src/main/fc/msp_server_fc.c"
    }
    return 1;
}
