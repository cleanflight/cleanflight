...
.LFB6:
	...
	call	clock_gettime	#
	.loc 1 61 0
	movq	current(%rip), %rdx	# current.tv_sec, D.5367
	movq	start(%rip), %rax	# start.tv_sec, D.5367
	subq	%rax, %rdx	# D.5367, D.5367
	movq	%rdx, %rax	# D.5367, D.5367
	imulq	$1000000000, %rax, %rdx	#, D.5367, D.5367
	movq	current+8(%rip), %rax	# current.tv_nsec, D.5367
	addq	%rax, %rdx	# D.5367, D.5367
	movq	start+8(%rip), %rax	# start.tv_nsec, D.5367
	movq	%rdx, %rcx	# D.5367, D.5367
	subq	%rax, %rcx	# D.5367, D.5367
	movabsq	$2361183241434822607, %rdx	#, tmp101
	movq	%rcx, %rax	# D.5367, tmp105
	imulq	%rdx	# tmp101
	sarq	$7, %rdx	#, tmp102
	movq	%rcx, %rax	# D.5367, tmp103
	sarq	$63, %rax	#, tmp103
	subq	%rax, %rdx	# tmp103, D.5367
	movq	%rdx, %rax	# D.5367, D.5367
	movl	%eax, sysTickUptime(%rip)	# D.5368, sysTickUptime
	.loc 1 62 0
	movl	sysTickUptime(%rip), %eax	# sysTickUptime, D.5368
	movl	%eax, usTicks(%rip)	# D.5368, usTicks
	.loc 1 65 0
	movl	sysTickUptime(%rip), %eax	# sysTickUptime, D.5369
	.loc 1 66 0
	popq	%rbp	#
	.cfi_def_cfa 7, 8
	ret
...
.LFB8:
	...
	call	clock_gettime	#
	.loc 1 80 0
	movq	start(%rip), %rax	# start.tv_sec, D.5372
	imulq	$1000000000, %rax, %rdx	#, D.5372, D.5372
	movq	start+8(%rip), %rax	# start.tv_nsec, D.5372
	leaq	(%rdx,%rax), %rcx	#, D.5372
	movabsq	$2361183241434822607, %rdx	#, tmp93
	movq	%rcx, %rax	# D.5372, tmp96
	imulq	%rdx	# tmp93
	sarq	$7, %rdx	#, tmp94
	movq	%rcx, %rax	# D.5372, tmp95
	sarq	$63, %rax	#, tmp95
	subq	%rax, %rdx	# tmp95, D.5372
	movq	%rdx, %rax	# D.5372, D.5372
	movq	%rax, %rsi	# D.5372,
	movl	$.LC0, %edi	#,
	movl	$0, %eax	#,
	call	printf	#
...
.LFB9:
	...
	imull	$1000, %eax, %eax	#, tmp88, D.5374
	movl	%eax, %edi	# D.5374,
	call	usleep	#
	.loc 1 86 0
	nop
...
.Ldebug_macro0:
	...
	.byte	0x4
	.byte	0x4
	.file 16 "/usr/lib/gcc/x86_64-linux-gnu/5/include/stdbool.h"
	.byte	0x3
	.uleb128 0x13
	.uleb128 0x10
	.byte	0x7
	.long	.Ldebug_macro9
	.byte	0x4
	.file 17 "/usr/lib/gcc/x86_64-linux-gnu/5/include/stdint.h"
	.byte	0x3
	.uleb128 0x14
	.uleb128 0x11
	.byte	0x3
	...
	.long	.Ldebug_macro28
	.byte	0x4
	.file 30 "/usr/include/x86_64-linux-gnu/bits/sigset.h"
	.byte	0x3
	.uleb128 0x21
	.uleb128 0x1e
	.byte	0x7
	...
	.uleb128 0x2c
	.long	.LASF671
	.file 31 "/usr/include/x86_64-linux-gnu/bits/time.h"
	.byte	0x3
	.uleb128 0x2d
	.uleb128 0x1f
	.byte	0x7
	...
	.long	.Ldebug_macro33
	.byte	0x4
	.file 32 "/usr/include/x86_64-linux-gnu/sys/sysmacros.h"
	.byte	0x3
	.uleb128 0xde
	.uleb128 0x20
	.byte	0x7
	...
	.byte	0x7
	.long	.Ldebug_macro35
	.file 33 "/usr/include/x86_64-linux-gnu/bits/pthreadtypes.h"
	.byte	0x3
	.uleb128 0x10e
	.uleb128 0x21
	.byte	0x5
	...
	.uleb128 0x17
	.uleb128 0x6
	.file 36 "./src/main/includes.h"
	.byte	0x3
	.uleb128 0x13
	.uleb128 0x24
	.file 37 "/usr/include/mraa.h"
	.byte	0x3
	.uleb128 0x1
	.uleb128 0x25
	.file 38 "/usr/include/mraa/pwm.h"
	.byte	0x3
	.uleb128 0x1e
	.uleb128 0x26
	...
	.byte	0x7
	.long	.Ldebug_macro48
	.file 43 "/usr/lib/gcc/x86_64-linux-gnu/5/include/stdarg.h"
	.byte	0x3
	.uleb128 0x31
	.uleb128 0x2b
	.byte	0x7
	...
	.byte	0x7
	.long	.Ldebug_macro51
	.file 44 "/usr/include/x86_64-linux-gnu/bits/stdio_lim.h"
	.byte	0x3
	.uleb128 0xa4
	.uleb128 0x2c
	.byte	0x7
	...
	.uleb128 0x17
	.long	.LASF856
	.file 47 "/usr/include/x86_64-linux-gnu/bits/fcntl.h"
	.byte	0x3
	.uleb128 0x23
	.uleb128 0x2f
	.byte	0x7
	.long	.Ldebug_macro54
	.file 48 "/usr/include/x86_64-linux-gnu/bits/fcntl-linux.h"
	.byte	0x3
	.uleb128 0x3d
	.uleb128 0x30
	.byte	0x7
	...
	.byte	0x7
	.long	.Ldebug_macro56
	.file 49 "/usr/include/x86_64-linux-gnu/bits/stat.h"
	.byte	0x3
	.uleb128 0x4d
	.uleb128 0x31
	.byte	0x7
	...
	.byte	0x4
	.byte	0x4
	.file 52 "/usr/include/mraa/aio.h"
	.byte	0x3
	.uleb128 0x1f
	.uleb128 0x34
	...
	.byte	0x4
	.byte	0x4
	.file 58 "/usr/include/mraa/gpio.h"
	.byte	0x3
	.uleb128 0x2d
	.uleb128 0x3a
	.file 59 "/usr/include/pthread.h"
	.byte	0x3
	.uleb128 0x2c
	.uleb128 0x3b
	.byte	0x5
	...
	.byte	0x7
	.long	.Ldebug_macro67
	.file 61 "/usr/include/x86_64-linux-gnu/bits/sched.h"
	.byte	0x3
	.uleb128 0x2b
	.uleb128 0x3d
	.byte	0x7
	...
	.long	.LASF1430
	.byte	0x4
	.file 62 "/usr/include/x86_64-linux-gnu/bits/setjmp.h"
	.byte	0x3
	.uleb128 0x1b
	.uleb128 0x3e
	.byte	0x5
	...
	.byte	0x4
	.byte	0x4
	.file 63 "/usr/include/mraa/spi.h"
	.byte	0x3
	.uleb128 0x21
	.uleb128 0x3f
	.byte	0x4
	.file 64 "/usr/include/mraa/i2c.h"
	.byte	0x3
	.uleb128 0x22
	.uleb128 0x40
	.byte	0x4
	.file 65 "/usr/include/mraa/uart.h"
	.byte	0x3
	.uleb128 0x23
	.uleb128 0x41
	.byte	0x4
	.file 66 "/usr/include/mraa/uart_ow.h"
	.byte	0x3
	.uleb128 0x24
	.uleb128 0x42
	.byte	0x5
	...
	.uleb128 0x1b
	.long	.LASF1454
	.file 68 "/usr/include/x86_64-linux-gnu/bits/errno.h"
	.byte	0x3
	.uleb128 0x23
	.uleb128 0x44
	.byte	0x7
	...
	.uleb128 0x18
	.uleb128 0x45
	.file 70 "/usr/include/x86_64-linux-gnu/asm/errno.h"
	.byte	0x3
	.uleb128 0x1
	.uleb128 0x46
	...
	.uleb128 0x17
	.long	.LASF1596
	.file 74 "/usr/include/x86_64-linux-gnu/bits/termios.h"
	.byte	0x3
	.uleb128 0x27
	.uleb128 0x4a
	.byte	0x7
	...
	.uleb128 0x2c
	.long	.LASF1740
	.file 75 "/usr/include/x86_64-linux-gnu/sys/ttydefaults.h"
	.byte	0x3
	.uleb128 0x68
	.uleb128 0x4b
	.byte	0x7
	...
	.byte	0x4
	.byte	0x4
	.file 76 "./src/main/drivers/serial.h"
	.byte	0x3
	.uleb128 0x14
	.uleb128 0x4c
	.byte	0x4
	...
	.long	.Ldebug_macro77
	.byte	0x4
	.file 77 "src/main/drivers/timer_setup.h"
	.byte	0x3
	.uleb128 0x18
	.uleb128 0x4d
	.file 78 "/usr/include/signal.h"
	.byte	0x3
	.uleb128 0x6
	.uleb128 0x4e
	.byte	0x5
	...
	.byte	0x7
	.long	.Ldebug_macro79
	.file 79 "/usr/include/x86_64-linux-gnu/bits/signum.h"
	.byte	0x3
	.uleb128 0x39
	.uleb128 0x4f
	.byte	0x7
	...
	.uleb128 0x4a
	.long	.LASF669
	.file 80 "/usr/include/x86_64-linux-gnu/bits/siginfo.h"
	.byte	0x3
	.uleb128 0x50
	.uleb128 0x50
	.byte	0x3
	...
	.byte	0x7
	.long	.Ldebug_macro82
	.file 81 "/usr/include/x86_64-linux-gnu/bits/sigaction.h"
	.byte	0x3
	.uleb128 0xf3
	.uleb128 0x51
	.byte	0x7
	.long	.Ldebug_macro83
	.byte	0x4
	.file 82 "/usr/include/x86_64-linux-gnu/bits/sigcontext.h"
	.byte	0x3
	.uleb128 0x132
	.uleb128 0x52
	.byte	0x7
	...
	.long	.Ldebug_macro26
	.byte	0x4
	.file 83 "/usr/include/x86_64-linux-gnu/bits/sigstack.h"
	.byte	0x3
	.uleb128 0x143
	.uleb128 0x53
	.byte	0x7
	.long	.Ldebug_macro85
	.byte	0x4
	.file 84 "/usr/include/x86_64-linux-gnu/sys/ucontext.h"
	.byte	0x3
	.uleb128 0x146
	.uleb128 0x54
	.byte	0x5
	...
	.long	.LASF2040
	.byte	0x4
	.file 85 "/usr/include/x86_64-linux-gnu/bits/sigthread.h"
	.byte	0x3
	.uleb128 0x16a
	.uleb128 0x55
	.byte	0x5
	...
	.byte	0x4
	.byte	0x4
	.file 86 "./src/main/drivers/gpio.h"
	.byte	0x3
	.uleb128 0x9
	.uleb128 0x56
	.byte	0x4
