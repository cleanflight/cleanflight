...
.LFB3:
	...
	subq	$96, %rsp	#,
	.loc 1 73 0
	movq	%fs:40, %rax	#, tmp121
	movq	%rax, -8(%rbp)	# tmp121, D.4763
	xorl	%eax, %eax	# tmp121
	.loc 1 76 0
	movq	$.LC0, -88(%rbp)	#, portname
	.loc 1 77 0
	movq	-88(%rbp), %rax	# portname, tmp112
	movl	$1052930, %esi	#,
	movq	%rax, %rdi	# tmp112,
	movl	$0, %eax	#,
	call	open	#
	movl	%eax, -92(%rbp)	# tmp113, fd
	.loc 1 78 0
	cmpl	$0, -92(%rbp)	#, fd
	jns	.L3	#,
	.loc 1 79 0
	...
	.loc 1 79 0
	movl	(%rax), %eax	# *_45, D.4759
	movl	%eax, %edi	# D.4759,
	call	strerror	#
	movq	%rax, %rdx	#, D.4762
	movq	-88(%rbp), %rax	# portname, tmp114
	movq	%rax, %rsi	# tmp114,
	movl	$.LC1, %edi	#,
	movl	$0, %eax	#,
	call	printf	#
...
.L3:
	...
	movl	-92(%rbp), %eax	# fd, tmp116
	movq	%rdx, %rsi	# tmp115,
	movl	%eax, %edi	# tmp116,
	call	tcgetattr	#
	testl	%eax, %eax	# D.4759
	jns	.L4	#,
	.loc 1 83 0
	call	__errno_location	#
	.loc 1 83 0
	movl	(%rax), %eax	# *_39, D.4759
	movl	%eax, %edi	# D.4759,
	call	strerror	#
	movq	%rax, %rsi	# D.4762,
	movl	$.LC2, %edi	#,
...
.L4:
	.loc 1 87 0
	movl	linecoding(%rip), %edx	# linecoding.bitrate, D.4760
	...
	call	cfsetispeed	#
	.loc 1 93 0
	movl	-72(%rbp), %eax	# tty.c_cflag, D.4760
	orl	$2176, %eax	#, D.4760
	movl	%eax, -72(%rbp)	# D.4760, tty.c_cflag
	.loc 1 94 0
	movl	-72(%rbp), %eax	# tty.c_cflag, D.4760
	andl	$-49, %eax	#, D.4760
	movl	%eax, -72(%rbp)	# D.4760, tty.c_cflag
	...
	.loc 1 98 0
	movl	-72(%rbp), %eax	# tty.c_cflag, D.4760
	andl	$2147483647, %eax	#, D.4760
	movl	%eax, -72(%rbp)	# D.4760, tty.c_cflag
	.loc 1 100 0
	leaq	-80(%rbp), %rdx	#, tmp119
	movl	-92(%rbp), %eax	# fd, tmp120
	movl	$0, %esi	#,
	movl	%eax, %edi	# tmp120,
	call	tcsetattr	#
	testl	%eax, %eax	# D.4759
...
.L5:
	...
	nop
	.loc 1 106 0
	movq	-8(%rbp), %rax	# D.4763, tmp122
	xorq	%fs:40, %rax	#, tmp122
	je	.L7	#,
