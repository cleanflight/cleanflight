...
.LFB6:
	...
	subq	$16, %rsp	#,
	.loc 1 102 0
	movq	portname(%rip), %rax	# portname, D.5062
	movl	$1054978, %esi	#,
	movq	%rax, %rdi	# D.5062,
	movl	$0, %eax	#,
	call	open	#
...
.LFB7:
	...
	movl	%eax, %edi	# tmp110,
	call	tcgetattr	#
	testl	%eax, %eax	# D.5066
	jns	.L8	#,
	.loc 1 118 0
	call	__errno_location	#
	.loc 1 118 0
	movl	(%rax), %eax	# *_36, D.5066
	movl	%eax, %edi	# D.5066,
	call	strerror	#
	movq	%rax, %rsi	# D.5069,
	movl	$.LC2, %edi	#,
...
.L8:
	.loc 1 122 0
	movl	linecoding(%rip), %edx	# linecoding.bitrate, D.5067
	...
	call	cfsetispeed	#
	.loc 1 128 0
	movl	-72(%rbp), %eax	# tty.c_cflag, D.5067
	orl	$2176, %eax	#, D.5067
	movl	%eax, -72(%rbp)	# D.5067, tty.c_cflag
	.loc 1 129 0
	movl	-72(%rbp), %eax	# tty.c_cflag, D.5067
	andl	$-49, %eax	#, D.5067
	movl	%eax, -72(%rbp)	# D.5067, tty.c_cflag
...
.L14:
	...
	movslq	%eax, %rdx	# tmp95, D.5077
	movl	USB+72(%rip), %eax	# USB.fd, D.5078
	movq	-24(%rbp), %rcx	# str, tmp96
	movq	%rcx, %rsi	# tmp96,
	movl	%eax, %edi	# D.5078,
	call	write	#
	movl	%eax, -4(%rbp)	# D.5079, wlen
	.loc 1 151 0
...
.LBB2:
	...
	movl	$0, %eax	#, tmp114
	movl	$16, %edx	#, tmp115
	movl	$readset, %esi	#, tmp116
	movq	%rdx, %rcx	# tmp115, tmp115
	movq	%rsi, %rdi	# tmp116, tmp116
#APP
# 163 "src/main/drivers/serial_uart.c" 1
	cld; rep; stosq
# 0 "" 2
#NO_APP
	movl	%edi, %eax	# tmp116, __d1
	movl	%ecx, %edx	# tmp115, __d0
	movl	%edx, -20(%rbp)	# __d0, __d0
	movl	%eax, -16(%rbp)	# __d1, __d1
.LBE2:
	.loc 1 164 0
	movl	USB+72(%rip), %eax	# USB.fd, D.5083
	.loc 1 164 0
	leal	63(%rax), %edx	#, tmp118
	testl	%eax, %eax	# tmp117
	cmovs	%edx, %eax	# tmp118,, tmp117
	sarl	$6, %eax	#, tmp119
	movl	%eax, %esi	# tmp119, D.5083
	movslq	%esi, %rax	# D.5083, tmp120
	movq	readset(,%rax,8), %rdi	# readset.__fds_bits, D.5084
	.loc 1 164 0
	movl	USB+72(%rip), %eax	# USB.fd, D.5083
	.loc 1 164 0
	cltd
	...
	.loc 1 164 0
	movl	$1, %edx	#, tmp126
	movl	%eax, %ecx	# D.5083, tmp151
	salq	%cl, %rdx	# tmp151, D.5085
	movq	%rdx, %rax	# D.5085, D.5085
	orq	%rax, %rdi	# D.5084, D.5084
	movq	%rdi, %rdx	# D.5084, D.5084
	movslq	%esi, %rax	# D.5083, tmp127
	movq	%rdx, readset(,%rax,8)	# D.5084, readset.__fds_bits
.L22:
	.loc 1 168 0
	movl	USB+72(%rip), %eax	# USB.fd, D.5083
	addl	$1, %eax	#, D.5083
	...
	movl	%eax, %edi	# D.5083,
	call	select	#
	movl	%eax, -12(%rbp)	# tmp128, result
	.loc 1 169 0
	cmpl	$-1, -12(%rbp)	#, result
	jne	.L18	#,
.LBB3:
	.loc 1 171 0
	movl	$0, %eax	#, tmp131
	movl	$16, %edx	#, tmp132
	movl	$readset, %esi	#, tmp133
	movq	%rdx, %rcx	# tmp132, tmp132
	movq	%rsi, %rdi	# tmp133, tmp133
#APP
# 171 "src/main/drivers/serial_uart.c" 1
	cld; rep; stosq
# 0 "" 2
#NO_APP
	movl	%edi, %eax	# tmp133, __d1
	movl	%ecx, %edx	# tmp132, __d0
	movl	%edx, -8(%rbp)	# __d0, __d0
	movl	%eax, -4(%rbp)	# __d1, __d1
.LBE3:
	.loc 1 172 0
	movl	USB+72(%rip), %eax	# USB.fd, D.5083
	.loc 1 172 0
	leal	63(%rax), %edx	#, tmp135
	testl	%eax, %eax	# tmp134
	cmovs	%edx, %eax	# tmp135,, tmp134
	sarl	$6, %eax	#, tmp136
	movl	%eax, %esi	# tmp136, D.5083
	movslq	%esi, %rax	# D.5083, tmp137
	movq	readset(,%rax,8), %rdi	# readset.__fds_bits, D.5084
	.loc 1 172 0
	movl	USB+72(%rip), %eax	# USB.fd, D.5083
	.loc 1 172 0
	...
	andl	$63, %eax	#, tmp141
	subl	%edx, %eax	# tmp139, tmp142
	.loc 1 172 0
	movl	$1, %edx	#, tmp143
	movl	%eax, %ecx	# D.5083, tmp156
	salq	%cl, %rdx	# tmp156, D.5085
	movq	%rdx, %rax	# D.5085, D.5085
	orq	%rax, %rdi	# D.5084, D.5084
	movq	%rdi, %rdx	# D.5084, D.5084
	movslq	%esi, %rax	# D.5083, tmp144
	movq	%rdx, readset(,%rax,8)	# D.5084, readset.__fds_bits
	jmp	.L22	#
.L18:
	.loc 1 174 0
	...
	jle	.L22	#,
	.loc 1 176 0
	movl	-44(%rbp), %eax	# len, tmp145
	movslq	%eax, %rdx	# tmp145, D.5085
	movl	USB+72(%rip), %eax	# USB.fd, D.5083
	movq	-40(%rbp), %rcx	# buf, tmp146
	movq	%rcx, %rsi	# tmp146,
	movl	%eax, %edi	# D.5083,
	call	read	#
	movl	%eax, rdlen(%rip)	# D.5083, rdlen
	.loc 1 177 0
	movl	rdlen(%rip), %eax	# rdlen, D.5083
	testl	%eax, %eax	# D.5083
	jle	.L20	#,
	.loc 1 179 0
	movl	-44(%rbp), %eax	# len, D.5082
	jmp	.L21	#
.L20:
	.loc 1 183 0
	movl	$.LC5, %edi	#,
...
.LFB11:
	...
	.cfi_def_cfa_register 6
	.loc 1 197 0
	movl	USB+76(%rip), %eax	# USB.deviceState, D.5091
	testl	%eax, %eax	# D.5091
	setne	%al	#, D.5092
	.loc 1 198 0
	popq	%rbp	#
	.cfi_def_cfa 7, 8
...
.LFB12:
	...
	.cfi_def_cfa_register 6
	.loc 1 202 0
	movl	USB+76(%rip), %eax	# USB.deviceState, D.5094
	cmpl	$5, %eax	#, D.5094
	sete	%al	#, D.5095
	.loc 1 203 0
	popq	%rbp	#
...
.LFB13:
	...
	.cfi_def_cfa_register 6
	.loc 1 207 0
	movl	rdlen(%rip), %eax	# rdlen, D.5097
	movl	%eax, receiveLength(%rip)	# D.5098, receiveLength
	.loc 1 209 0
	nop
	popq	%rbp	#
	.cfi_def_cfa 7, 8
...
.LFB14:
	...
	.cfi_def_cfa_register 6
	.loc 1 213 0
	movl	linecoding(%rip), %eax	# linecoding.bitrate, D.5099
	.loc 1 214 0
	popq	%rbp	#
	.cfi_def_cfa 7, 8
	ret
...
.Ldebug_macro0:
	...
	.long	.LASF712
	.byte	0x4
	.file 37 "./src/main/includes.h"
	.byte	0x3
	.uleb128 0x1c
	.uleb128 0x25
	.file 38 "/usr/include/mraa.h"
	.byte	0x3
	.uleb128 0x1
	.uleb128 0x26
	.file 39 "/usr/include/mraa/pwm.h"
	.byte	0x3
	.uleb128 0x1e
	.uleb128 0x27
	...
	.byte	0x7
	.long	.Ldebug_macro43
	.file 44 "/usr/lib/gcc/x86_64-linux-gnu/5/include/stdarg.h"
	.byte	0x3
	.uleb128 0x31
	.uleb128 0x2c
	.byte	0x7
	...
	.byte	0x7
	.long	.Ldebug_macro46
	.file 45 "/usr/include/x86_64-linux-gnu/bits/stdio_lim.h"
	.byte	0x3
	.uleb128 0xa4
	.uleb128 0x2d
	.byte	0x7
	...
	.uleb128 0x17
	.long	.LASF838
	.file 48 "/usr/include/x86_64-linux-gnu/bits/fcntl.h"
	.byte	0x3
	.uleb128 0x23
	.uleb128 0x30
	.byte	0x7
	.long	.Ldebug_macro49
	.file 49 "/usr/include/x86_64-linux-gnu/bits/fcntl-linux.h"
	.byte	0x3
	.uleb128 0x3d
	.uleb128 0x31
	.byte	0x7
	...
	.long	.Ldebug_macro52
	.byte	0x4
	.file 50 "/usr/include/x86_64-linux-gnu/bits/stat.h"
	.byte	0x3
	.uleb128 0x4d
	.uleb128 0x32
	.byte	0x7
	...
	.long	.Ldebug_macro54
	.byte	0x4
	.file 51 "/usr/include/mraa/common.h"
	.byte	0x3
	.uleb128 0x2e
	.uleb128 0x33
	.file 52 "/usr/include/mraa/types.h"
	.byte	0x3
	.uleb128 0x1c
	.uleb128 0x34
	.byte	0x4
	...
	.byte	0x4
	.byte	0x4
	.file 53 "/usr/include/mraa/aio.h"
	.byte	0x3
	.uleb128 0x1f
	.uleb128 0x35
	...
	.byte	0x7
	.long	.Ldebug_macro56
	.file 55 "/usr/include/x86_64-linux-gnu/bits/posix_opt.h"
	.byte	0x3
	.uleb128 0xcd
	.uleb128 0x37
	.byte	0x7
	.long	.Ldebug_macro57
	.byte	0x4
	.file 56 "/usr/include/x86_64-linux-gnu/bits/environments.h"
	.byte	0x3
	.uleb128 0xd1
	.uleb128 0x38
	.byte	0x3
	...
	.byte	0x7
	.long	.Ldebug_macro60
	.file 57 "/usr/include/x86_64-linux-gnu/bits/confname.h"
	.byte	0x3
	.uleb128 0x264
	.uleb128 0x39
	.byte	0x7
	...
	.byte	0x4
	.byte	0x4
	.file 59 "/usr/include/mraa/gpio.h"
	.byte	0x3
	.uleb128 0x2d
	.uleb128 0x3b
	.file 60 "/usr/include/pthread.h"
	.byte	0x3
	.uleb128 0x2c
	.uleb128 0x3c
	.byte	0x5
	...
	.long	.Ldebug_macro52
	.byte	0x4
	.file 62 "/usr/include/x86_64-linux-gnu/bits/sched.h"
	.byte	0x3
	.uleb128 0x2b
	.uleb128 0x3e
	.byte	0x7
	...
	.long	.LASF1429
	.byte	0x4
	.file 64 "/usr/include/x86_64-linux-gnu/bits/setjmp.h"
	.byte	0x3
	.uleb128 0x1b
	.uleb128 0x40
	.byte	0x5
	...
	.byte	0x4
	.byte	0x4
	.file 65 "/usr/include/mraa/spi.h"
	.byte	0x3
	.uleb128 0x21
	.uleb128 0x41
	.byte	0x4
	.file 66 "/usr/include/mraa/i2c.h"
	.byte	0x3
	.uleb128 0x22
	.uleb128 0x42
	.byte	0x4
	...
	.uleb128 0x4
	.byte	0x4
	.file 67 "/usr/include/mraa/uart_ow.h"
	.byte	0x3
	.uleb128 0x24
	.uleb128 0x43
	.byte	0x5
	...
	.uleb128 0x2c
	.long	.LASF1740
	.file 76 "/usr/include/x86_64-linux-gnu/sys/ttydefaults.h"
	.byte	0x3
	.uleb128 0x68
	.uleb128 0x4c
	.byte	0x7
	...
	.long	.Ldebug_macro76
	.byte	0x4
	.file 77 "./src/main/drivers/system.h"
	.byte	0x3
	.uleb128 0x20
	.uleb128 0x4d
	.byte	0x4
	.file 78 "./src/main/platform.h"
	.byte	0x3
	.uleb128 0x21
	.uleb128 0x4e
	.byte	0x4
	.file 79 "./src/main/build/build_config.h"
	.byte	0x3
	.uleb128 0x23
	.uleb128 0x4f
	.byte	0x7
	.long	.Ldebug_macro77
	.byte	0x4
	.file 80 "./src/main/common/utils.h"
	.byte	0x3
	.uleb128 0x25
	.uleb128 0x50
	.byte	0x3
