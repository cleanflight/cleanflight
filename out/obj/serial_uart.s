...
.LFB4:
	...
	subq	$16, %rsp	#,
	.loc 1 85 0
	movq	portname(%rip), %rax	# portname, D.4822
	movl	$1052930, %esi	#,
	movq	%rax, %rdi	# D.4822,
	movl	$0, %eax	#,
	call	open	#
...
.LC3:
	...
	.section	.text.usbAttributesSet,"ax",@progbits
	.globl	usbAttributesSet
	.type	usbAttributesSet, @function
usbAttributesSet:
.LFB5:
	.loc 1 96 0
	.cfi_startproc
...
.L8:
	.loc 1 104 0
	movl	linecoding(%rip), %edx	# linecoding.bitrate, D.4827
	...
	call	cfsetispeed	#
	.loc 1 110 0
	movl	-72(%rbp), %eax	# tty.c_cflag, D.4827
	orl	$2176, %eax	#, D.4827
	movl	%eax, -72(%rbp)	# D.4827, tty.c_cflag
	.loc 1 111 0
	movl	-72(%rbp), %eax	# tty.c_cflag, D.4827
	andl	$-49, %eax	#, D.4827
	movl	%eax, -72(%rbp)	# D.4827, tty.c_cflag
...
.L11:
	...
	.cfi_endproc
.LFE5:
	.size	usbAttributesSet, .-usbAttributesSet
	.section	.rodata
.LC4:
...
.L14:
	...
	movslq	%eax, %rdx	# tmp96, D.4837
	movl	USB+24(%rip), %eax	# USB.fd, D.4835
	movq	-24(%rbp), %rcx	# str, tmp97
	movq	%rcx, %rsi	# tmp97,
	movl	%eax, %edi	# D.4835,
	call	write	#
	movl	%eax, -4(%rbp)	# D.4838, wlen
	.loc 1 135 0
...
.LFB7:
	...
	.cfi_def_cfa_register 6
	.loc 1 147 0
	movl	USB+28(%rip), %eax	# USB.isconnected, D.4842
...
.Ldebug_macro0:
	...
	.long	.LASF712
	.byte	0x4
	.file 35 "src/main/drivers/../includes.h"
	.byte	0x3
	.uleb128 0x1c
	.uleb128 0x23
