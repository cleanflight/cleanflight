...
.LFB4:
	...
	subq	$16, %rsp	#,
	.loc 1 85 0
	movq	portname(%rip), %rax	# portname, D.4838
	movl	$1052930, %esi	#,
	movq	%rax, %rdi	# D.4838,
	movl	$0, %eax	#,
	call	open	#
...
.L5:
	...
	movl	%eax, USB+24(%rip)	# tmp95, USB.fd
	.loc 1 91 0
	movl	$1, USB+28(%rip)	#, USB.isconnected
	.loc 1 92 0
	movl	-4(%rbp), %eax	# fd, D.4839
	.loc 1 93 0
	leave
	.cfi_def_cfa 7, 8
	ret
...
.LFB5:
	...
	movl	%eax, %edi	# tmp110,
	call	tcgetattr	#
	testl	%eax, %eax	# D.4842
	jns	.L8	#,
	.loc 1 100 0
	call	__errno_location	#
	.loc 1 100 0
	movl	(%rax), %eax	# *_36, D.4842
	movl	%eax, %edi	# D.4842,
	call	strerror	#
	movq	%rax, %rsi	# D.4845,
	movl	$.LC2, %edi	#,
...
.L8:
	.loc 1 104 0
	movl	linecoding(%rip), %edx	# linecoding.bitrate, D.4843
	...
	call	cfsetispeed	#
	.loc 1 110 0
	movl	-72(%rbp), %eax	# tty.c_cflag, D.4843
	orl	$2176, %eax	#, D.4843
	movl	%eax, -72(%rbp)	# D.4843, tty.c_cflag
	.loc 1 111 0
	movl	-72(%rbp), %eax	# tty.c_cflag, D.4843
	andl	$-49, %eax	#, D.4843
	movl	%eax, -72(%rbp)	# D.4843, tty.c_cflag
...
.LFB6:
	...
	.cfi_def_cfa_register 6
	.loc 1 127 0
	movl	USB+28(%rip), %eax	# USB.isconnected, D.4852
...
.L17:
	.loc 1 140 0
	movl	-28(%rbp), %eax	# len, tmp96
	movslq	%eax, %rdx	# tmp96, D.4855
	movl	USB+24(%rip), %eax	# USB.fd, D.4853
	movq	-24(%rbp), %rcx	# str, tmp97
	movq	%rcx, %rsi	# tmp97,
	movl	%eax, %edi	# D.4853,
	call	write	#
	movl	%eax, -4(%rbp)	# D.4856, wlen
	.loc 1 142 0
	movl	-4(%rbp), %eax	# wlen, tmp98
	cmpl	-28(%rbp), %eax	# len, tmp98
	je	.L19	#,
	.loc 1 144 0
	call	__errno_location	#
	.loc 1 144 0
	movl	(%rax), %edx	# *_16, D.4853
	movl	-4(%rbp), %eax	# wlen, tmp99
	movl	%eax, %esi	# tmp99,
	movl	$.LC4, %edi	#,
	movl	$0, %eax	#,
	call	printf	#
...
.LFB8:
	...
	.loc 1 156 0
	movl	-20(%rbp), %eax	# len, tmp93
	cltq
	movq	%rax, %rdi	# D.4860,
	call	malloc	#
	movq	%rax, -8(%rbp)	# tmp94, buf
	.loc 1 157 0
	movl	-20(%rbp), %eax	# len, tmp95
	movslq	%eax, %rdx	# tmp95, D.4860
	movl	USB+24(%rip), %eax	# USB.fd, D.4861
	movq	-8(%rbp), %rcx	# buf, tmp96
	movq	%rcx, %rsi	# tmp96,
	movl	%eax, %edi	# D.4861,
	call	read	#
	movl	%eax, -12(%rbp)	# D.4862, rdlen
	.loc 1 158 0
	cmpl	$0, -12(%rbp)	#, rdlen
	jle	.L21	#,
	.loc 1 160 0
	movq	-8(%rbp), %rax	# buf, D.4859
	jmp	.L22	#
.L21:
	.loc 1 164 0
	movl	$.LC5, %edi	#,
...
.Letext0:
	...
	.file 3 "/usr/include/mraa/uart.h"
	.file 4 "/usr/include/x86_64-linux-gnu/bits/termios.h"
	.file 5 "src/main/drivers/serial_uart.h"
...
.Ldebug_macro0:
	...
	.uleb128 0x2e
	.uleb128 0x31
	.file 50 "/usr/include/mraa/types.h"
	.byte	0x3
	.uleb128 0x1c
	.uleb128 0x32
	.byte	0x4
	...
	.byte	0x4
	.byte	0x4
	.file 51 "/usr/include/mraa/aio.h"
	.byte	0x3
	.uleb128 0x1f
	.uleb128 0x33
	.file 52 "/usr/include/unistd.h"
	.byte	0x3
	.uleb128 0x29
	.uleb128 0x34
	.byte	0x7
	.long	.Ldebug_macro56
	.file 53 "/usr/include/x86_64-linux-gnu/bits/posix_opt.h"
	.byte	0x3
	.uleb128 0xcd
	.uleb128 0x35
	.byte	0x7
	.long	.Ldebug_macro57
	.byte	0x4
	.file 54 "/usr/include/x86_64-linux-gnu/bits/environments.h"
	.byte	0x3
	.uleb128 0xd1
	.uleb128 0x36
	.byte	0x3
	...
	.byte	0x7
	.long	.Ldebug_macro60
	.file 55 "/usr/include/x86_64-linux-gnu/bits/confname.h"
	.byte	0x3
	.uleb128 0x264
	.uleb128 0x37
	.byte	0x7
	...
	.byte	0x4
	.byte	0x4
	.file 57 "/usr/include/mraa/gpio.h"
	.byte	0x3
	.uleb128 0x2d
	.uleb128 0x39
	.file 58 "/usr/include/pthread.h"
	.byte	0x3
	.uleb128 0x2c
	.uleb128 0x3a
	.byte	0x5
	...
	.long	.Ldebug_macro52
	.byte	0x4
	.file 60 "/usr/include/x86_64-linux-gnu/bits/sched.h"
	.byte	0x3
	.uleb128 0x2b
	.uleb128 0x3c
	.byte	0x7
	...
	.uleb128 0x1b
	.long	.LASF1453
	.file 67 "/usr/include/x86_64-linux-gnu/bits/errno.h"
	.byte	0x3
	.uleb128 0x23
	.uleb128 0x43
	.byte	0x7
	.long	.Ldebug_macro68
	.file 68 "/usr/include/linux/errno.h"
	.byte	0x3
	.uleb128 0x18
	.uleb128 0x44
	.file 69 "/usr/include/x86_64-linux-gnu/asm/errno.h"
	.byte	0x3
	.uleb128 0x1
	.uleb128 0x45
	.file 70 "/usr/include/asm-generic/errno.h"
	.byte	0x3
	.uleb128 0x1
	.uleb128 0x46
	.byte	0x5
	.uleb128 0x2
	.long	.LASF1457
	.file 71 "/usr/include/asm-generic/errno-base.h"
	.byte	0x3
	.uleb128 0x4
	.uleb128 0x47
	.byte	0x7
...
.LASF1809:
	.string	"rxDMAPeripheralBaseAddr"
.LASF1338:
...
.LASF1478:
	.string	"ENOTDIR 20"
.LASF1808:
	.string	"txDMAPeripheralBaseAddr"
.LASF1806:
	.string	"rxDMAPos"
.LASF1498:
	.string	"ELOOP 40"
