...
.LFB0:
	...
	movzwl	(%rax), %eax	# reg_2(D)->pgn, D.2332
	andw	$4095, %ax	#, D.2333
	popq	%rbp	#
	.cfi_def_cfa 7, 8
	ret
...
.LFB1:
	...
	movzwl	(%rax), %eax	# reg_2(D)->pgn, D.2334
	shrw	$12, %ax	#, D.2334
	popq	%rbp	#
	.cfi_def_cfa 7, 8
	ret
...
.LFB2:
	...
	.loc 1 52 0
	movq	-8(%rbp), %rax	# reg, tmp90
	movzwl	2(%rax), %eax	# reg_2(D)->size, D.2336
	andw	$4095, %ax	#, D.2337
	popq	%rbp	#
	.cfi_def_cfa 7, 8
	ret
...
.LFB3:
	...
	movzwl	2(%rax), %eax	# reg_2(D)->size, D.2338
	notl	%eax	# tmp93
	shrw	$15, %ax	#, tmp94
	movzbl	%al, %eax	# D.2340, D.2341
	popq	%rbp	#
	.cfi_def_cfa 7, 8
	ret
	.cfi_endproc
...
.LFB4:
	...
	.cfi_def_cfa_register 6
	subq	$24, %rsp	#,
	movl	%edi, %eax	# pgn, tmp90
	movw	%ax, -20(%rbp)	# tmp90, pgn
.LBB2:
	.loc 2 28 0
	movq	$__pg_registry_start, -8(%rbp)	#, reg
	jmp	.L10	#
.L13:
	.loc 2 29 0
	movq	-8(%rbp), %rax	# reg, tmp91
	movq	%rax, %rdi	# tmp91,
	call	pgN	#
	cmpw	-20(%rbp), %ax	# pgn, D.2343
	jne	.L11	#,
	.loc 2 30 0
	movq	-8(%rbp), %rax	# reg, D.2342
	jmp	.L12	#
.L11:
...
.L10:
	...
	cmpq	$__pg_registry_end, -8(%rbp)	#, reg
	jb	.L13	#,
.LBE2:
...
.LFB5:
	...
	jne	.L15	#,
	.loc 2 42 0
	movzwl	-10(%rbp), %edx	# regSize, D.2345
	movzbl	-28(%rbp), %eax	# profileIndex, D.2345
	imull	%edx, %eax	# D.2345, D.2345
	cltq
	addq	%rax, -8(%rbp)	# D.2346, base
.L15:
	.loc 2 44 0
	movq	-8(%rbp), %rax	# base, D.2347
	.loc 2 45 0
	leave
	.cfi_def_cfa 7, 8
	ret
...
.LFB6:
	...
	movq	%rax, %rdi	# tmp95,
	call	pgSize	#
	movw	%ax, -2(%rbp)	# tmp96, regSize
	.loc 2 51 0
	movzwl	-2(%rbp), %edx	# regSize, D.2348
	movq	-32(%rbp), %rax	# base, tmp97
	movl	$0, %esi	#,
	movq	%rax, %rdi	# tmp97,
	call	memset	#
	.loc 2 52 0
	movq	-24(%rbp), %rax	# reg, tmp98
	movq	24(%rax), %rax	# reg_3(D)->reset.ptr, D.2349
	cmpq	$__pg_resetdata_start, %rax	#, D.2349
	jb	.L18	#,
	.loc 2 52 0 is_stmt 0 discriminator 1
	movq	-24(%rbp), %rax	# reg, tmp99
	movq	24(%rax), %rax	# reg_3(D)->reset.ptr, D.2349
	cmpq	$__pg_resetdata_end, %rax	#, D.2349
	jnb	.L18	#,
	.loc 2 54 0 is_stmt 1
	movzwl	-2(%rbp), %edx	# regSize, D.2348
	movq	-24(%rbp), %rax	# reg, tmp100
	movq	24(%rax), %rcx	# reg_3(D)->reset.ptr, D.2349
	movq	-32(%rbp), %rax	# base, tmp101
	movq	%rcx, %rsi	# D.2349,
	movq	%rax, %rdi	# tmp101,
	call	memcpy	#
	.loc 2 59 0
...
.L18:
	...
	movq	24(%rax), %rax	# reg_3(D)->reset.fn, D.2350
	testq	%rax, %rax	# D.2350
	je	.L20	#,
	.loc 2 57 0
	movq	-24(%rbp), %rax	# reg, tmp103
	movq	24(%rax), %rax	# reg_3(D)->reset.fn, D.2350
	movzwl	-2(%rbp), %ecx	# regSize, D.2351
	movq	-32(%rbp), %rdx	# base, tmp104
	movl	%ecx, %esi	# D.2351,
	movq	%rdx, %rdi	# tmp104,
	call	*%rax	# D.2350
.L20:
...
.LFB8:
	...
	.loc 2 69 0
	movq	-8(%rbp), %rax	# reg, tmp92
	movq	8(%rax), %rdx	# reg_3(D)->address, D.2356
...
.L23:
	...
	movq	16(%rax), %rax	# reg_3(D)->ptr, D.2357
	movq	(%rax), %rdx	# *_8, D.2356
...
.LFB9:
	...
	movq	%rax, %rdi	# tmp103,
	call	pgVersion	#
	movzbl	%al, %eax	# D.2359, D.2358
	cmpl	-60(%rbp), %eax	# version, D.2358
	jne	.L30	#,
.LBB3:
	.loc 2 80 0
	...
	movq	%rax, %rdi	# tmp104,
	call	pgSize	#
	movzwl	%ax, %eax	# D.2361, D.2358
	cmpl	-48(%rbp), %eax	# size, D.2358
	jg	.L28	#,
...
.L28:
	...
	movl	-48(%rbp), %eax	# size, D.2358
.L29:
	.loc 2 80 0 discriminator 4
	movl	%eax, -20(%rbp)	# D.2358, take
	.loc 2 81 0 is_stmt 1 discriminator 4
	movl	-20(%rbp), %eax	# take, tmp106
	movslq	%eax, %rbx	# tmp106, D.2362
...
.LFB10:
	...
	movq	%rax, %rdi	# tmp97,
	call	pgSize	#
	movzwl	%ax, %eax	# D.2364, D.2363
	cmpl	-52(%rbp), %eax	# size, D.2363
	jg	.L32	#,
...
.L32:
	...
	movl	-52(%rbp), %eax	# size, D.2363
.L33:
	.loc 2 87 0 discriminator 4
	movl	%eax, -20(%rbp)	# D.2363, take
	.loc 2 88 0 is_stmt 1 discriminator 4
	movl	-20(%rbp), %eax	# take, tmp99
	movslq	%eax, %rbx	# tmp99, D.2365
	movzbl	-56(%rbp), %edx	# profileIndex, D.2363
	...
	movl	-20(%rbp), %eax	# take, D.2363
	.loc 2 90 0 discriminator 4
	addq	$56, %rsp	#,
	popq	%rbx	#
	popq	%rbp	#
	.cfi_def_cfa 7, 8
...
.L40:
	...
	movl	-12(%rbp), %edx	# profileIndex, tmp90
	movq	-8(%rbp), %rax	# reg, tmp91
	movl	%edx, %esi	# tmp90,
	movq	%rax, %rdi	# tmp91,
	call	pgReset	#
...
.L39:
	...
	movl	-12(%rbp), %eax	# profileIndex, tmp92
	cmpl	-20(%rbp), %eax	# profileCount, tmp92
	jl	.L40	#,
.L38:
.LBE5:
	.loc 2 95 0 is_stmt 1 discriminator 2
	addq	$32, -8(%rbp)	#, reg
.L36:
...
.LBB6:
	.loc 2 109 0
	movq	$__pg_registry_start, -16(%rbp)	#, reg
	jmp	.L43	#
.L45:
	.loc 2 110 0
...
.LBB7:
	.loc 2 111 0
	movl	-20(%rbp), %eax	# profileIndex, tmp92
	movzbl	%al, %edx	# D.2369, D.2370
	...
	movq	16(%rax), %rax	# reg_1->ptr, D.2371
	movq	-8(%rbp), %rdx	# ptr, tmp96
	movq	%rdx, (%rax)	# tmp96, *_13
.L44:
.LBE7:
...
.L43:
	...
	cmpq	$__pg_registry_end, -16(%rbp)	#, reg
	jb	.L45	#,
.LBE6:
...
.Ldebug_macro11:
	...
	.long	.LASF507
	.byte	0
	.section	.debug_macro,"G",@progbits,wm4.parameter_group.h.55.9a0c0a1c1716ff5042c37cdc58e4bf33,comdat
.Ldebug_macro12:
	.value	0x4
	.byte	0
	.byte	0x5
...
.LASF516:
	.string	"PG_DECLARE(_type,_name) extern _type _name ## _System; static inline _type* _name(void) { return &_name ## _System; } struct _dummy"
.LASF231:
	.string	"__FXSR__ 1"
.LASF362:
