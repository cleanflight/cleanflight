...
# 762 "src/main/fc/boot.c"
void configureScheduler(void)
{
    schedulerInit();
    setTaskEnabled(TASK_SYSTEM, 
# 765 "src/main/fc/boot.c" 3 4
                               1
# 765 "src/main/fc/boot.c"
                                   );
...
int main(void)
{
    ...
    configureScheduler();
    serialInit(
# 816 "src/main/fc/boot.c" 3 4
              1
# 816 "src/main/fc/boot.c"
                  );
    mspInit();
    mspSerialInit();
    while (
# 819 "src/main/fc/boot.c" 3 4
          1
# 819 "src/main/fc/boot.c"
              ) {
        scheduler();

    }
    return 0;
# 848 "src/main/fc/boot.c"
}
