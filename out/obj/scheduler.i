...
# 205 "src/main/scheduler/scheduler.c"
                                               ;
    for (const cfTask_t *task = queueFirst(); task != 
# 206 "src/main/scheduler/scheduler.c" 3 4
                                                     ((void *)0) 
# 206 "src/main/scheduler/scheduler.c"
    ...
    const 
# 215 "src/main/scheduler/scheduler.c" 3 4
         _Bool 
# 215 "src/main/scheduler/scheduler.c"
...
# 222 "src/main/scheduler/scheduler.c"
        ...
        if (task->checkFunc != 
# 224 "src/main/scheduler/scheduler.c" 3 4
                              ((void *)0)
# 224 "src/main/scheduler/scheduler.c"
                                  ) {
...
# 249 "src/main/scheduler/scheduler.c"
    ...
    if (selectedTask != 
# 264 "src/main/scheduler/scheduler.c" 3 4
                       ((void *)0)
# 264 "src/main/scheduler/scheduler.c"
                           ) {
