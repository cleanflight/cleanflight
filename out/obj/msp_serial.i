...
# 215 "src/main/msp/msp_serial.c"
static 
# 215 "src/main/msp/msp_serial.c" 3 4
      _Bool 
# 215 "src/main/msp/msp_serial.c"
        ...
        case IDLE:
            if (c != '$')
            {
                if(c == 'M')
                {
                    ...
                    return 
# 227 "src/main/msp/msp_serial.c" 3 4
                          1
# 227 "src/main/msp/msp_serial.c"
                              ;
                }
                return 
...
# 229 "src/main/msp/msp_serial.c"
    ...
    return 
# 284 "src/main/msp/msp_serial.c" 3 4
          1
# 284 "src/main/msp/msp_serial.c"
              ;
}
...
# 300 "src/main/msp/msp_serial.c" 3 4
           _Bool 
# 300 "src/main/msp/msp_serial.c"
        ...
        if (mspPostProcessFn != 
# 326 "src/main/msp/msp_serial.c" 3 4
                               ((void *)0)
# 326 "src/main/msp/msp_serial.c"
                                   ) {
            mspPostProcessFn(msp);
            mspPostProcessFn = 
# 328 "src/main/msp/msp_serial.c" 3 4
                              ((void *)0)
# 328 "src/main/msp/msp_serial.c"
                                  ;
        }
...
# 348 "src/main/msp/msp_serial.c" 3 4
           _Bool 
# 348 "src/main/msp/msp_serial.c"
