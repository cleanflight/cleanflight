...
# 114 "src/main/msp/msp_serial.c" 3 4
                                 ((void *)0)
# 114 "src/main/msp/msp_serial.c"
                                     );
        }
    }
}
...
# 213 "src/main/msp/msp_serial.c"
static 
# 213 "src/main/msp/msp_serial.c" 3 4
      _Bool 
# 213 "src/main/msp/msp_serial.c"
           mspSerialProcessReceivedByte(mspPort_t *msp, uint8_t c)
{
    switch(msp->c_state) {
        ...
        case IDLE:
            if (c != '$')
                return 
# 219 "src/main/msp/msp_serial.c" 3 4
                      0
# 219 "src/main/msp/msp_serial.c"
                           ;
    ...
    return 
# 270 "src/main/msp/msp_serial.c" 3 4
          1
# 270 "src/main/msp/msp_serial.c"
              ;
}
...
# 324 "src/main/msp/msp_serial.c" 3 4
           _Bool 
# 324 "src/main/msp/msp_serial.c"
