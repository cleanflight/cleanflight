...
void mspSerialAllocatePorts(void)
{
    for(serialPortConfig_t *portConfig = findSerialPortConfig(FUNCTION_MSP_SERVER | FUNCTION_MSP_CLIENT);
        portConfig != 
# 69 "src/main/msp/msp_serial.c" 3 4
                     ((void *)0)
# 69 "src/main/msp/msp_serial.c"
                         ;
        ...
        if(mspPort == 
# 76 "src/main/msp/msp_serial.c" 3 4
                     ((void *)0)
# 76 "src/main/msp/msp_serial.c"
                         ) {
...
# 112 "src/main/msp/msp_serial.c" 3 4
                                 ((void *)0)
# 112 "src/main/msp/msp_serial.c"
                                     );
        }
    }
}
...
# 120 "src/main/msp/msp_serial.c" 3 4
                                  ((void *)0)
# 120 "src/main/msp/msp_serial.c"
                                      );
    }
...
# 212 "src/main/msp/msp_serial.c"
static 
# 212 "src/main/msp/msp_serial.c" 3 4
      _Bool 
# 212 "src/main/msp/msp_serial.c"
           mspSerialProcessReceivedByte(mspPort_t *msp, uint8_t c)
{
    switch(msp->c_state) {
        ...
        case IDLE:
            if (c != '$')
                return 
# 218 "src/main/msp/msp_serial.c" 3 4
                      0
# 218 "src/main/msp/msp_serial.c"
                           ;
    ...
    return 
# 269 "src/main/msp/msp_serial.c" 3 4
          1
# 269 "src/main/msp/msp_serial.c"
              ;
}
...
# 283 "src/main/msp/msp_serial.c" 3 4
           _Bool 
# 283 "src/main/msp/msp_serial.c"
        ...
        if (mspPostProcessFn) {
            ...
            mspPostProcessFn = 
# 303 "src/main/msp/msp_serial.c" 3 4
                              ((void *)0)
# 303 "src/main/msp/msp_serial.c"
                                  ;
        }
...
# 323 "src/main/msp/msp_serial.c" 3 4
           _Bool 
# 323 "src/main/msp/msp_serial.c"
            ...
            msp->commandSenderFn = 
# 331 "src/main/msp/msp_serial.c" 3 4
                                  ((void *)0)
# 331 "src/main/msp/msp_serial.c"
                                      ;
        }
    }
}
