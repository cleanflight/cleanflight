# 1 "src/main/drivers/timer_setup.c"
...
# 4 "src/main/drivers/timer_setup.h" 2
...
# 6 "src/main/drivers/timer_setup.h" 2
...
# 8 "src/main/drivers/timer_setup.h" 2
...
# 2 "src/main/drivers/timer_setup.c" 2

static void handler(int sig, siginfo_t *si, void *uc)
{
 timer_info_t* timer_info;
 timer_info = si->
# 6 "src/main/drivers/timer_setup.c" 3 4
                 _sifields._rt.si_sigval
# 6 "src/main/drivers/timer_setup.c"
                         .sival_ptr;
...
{
 sa->sa_flags = 
# 14 "src/main/drivers/timer_setup.c" 3 4
               4
# 14 "src/main/drivers/timer_setup.c"
                         ;
 sa->
# 15 "src/main/drivers/timer_setup.c" 3 4
    __sigaction_handler.sa_sigaction 
# 15 "src/main/drivers/timer_setup.c"
                 = handler;
 sigemptyset(&(sa->sa_mask));
 if (sigaction(
# 17 "src/main/drivers/timer_setup.c" 3 4
              (__libc_current_sigrtmin ())
# 17 "src/main/drivers/timer_setup.c"
                 , sa, 
# 17 "src/main/drivers/timer_setup.c" 3 4
                       ((void *)0)
# 17 "src/main/drivers/timer_setup.c"
                           ) == -1)
  do { perror("sigaction"); exit(
# 18 "src/main/drivers/timer_setup.c" 3 4
 1
# 18 "src/main/drivers/timer_setup.c"
 ); } while (0);
}
...
void timercreate(timer_t* timerid, struct sigevent* sev, void (* handler)(int, siginfo_t*, void*), timer_info_t* timer_info)
{
 ...
 sev->sigev_notify = 
# 24 "src/main/drivers/timer_setup.c" 3 4
                    SIGEV_SIGNAL
# 24 "src/main/drivers/timer_setup.c"
                                ;
 sev->sigev_signo = 
# 25 "src/main/drivers/timer_setup.c" 3 4
                   (__libc_current_sigrtmin ())
# 25 "src/main/drivers/timer_setup.c"
                      ;
 sev->sigev_value.sival_ptr = timer_info;
 if (timer_create(
# 27 "src/main/drivers/timer_setup.c" 3 4
                 0
# 27 "src/main/drivers/timer_setup.c"
                        , sev, timerid) == -1)
  do { perror("timer_create"); exit(
# 28 "src/main/drivers/timer_setup.c" 3 4
 1
# 28 "src/main/drivers/timer_setup.c"
 ); } while (0);
...
void timer_start(struct itimerspec* its, timer_t* timerid, float freq, int mode)
{
 ...
 switch(mode) {
  ...
  default:
   do { perror("Invalid mode\n"); exit(
# 58 "src/main/drivers/timer_setup.c" 3 4
  1
# 58 "src/main/drivers/timer_setup.c"
  ); } while (0);
 }
 if (timer_settime(*timerid, 0, its, 
# 60 "src/main/drivers/timer_setup.c" 3 4
                                    ((void *)0)
# 60 "src/main/drivers/timer_setup.c"
                                        ) == -1)
   do { perror("timer_settime"); exit(
# 61 "src/main/drivers/timer_setup.c" 3 4
  1
# 61 "src/main/drivers/timer_setup.c"
  ); } while (0);
}
...

{
 ...
 setup_sigaction(&sa, &mask);
 timercreate(&timerid, &sev, &handler, timer_info);
 timer_start(&its, &timerid, freq, mode);
