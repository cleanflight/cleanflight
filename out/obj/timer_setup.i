...
# 16 "src/main/drivers/timer_setup.h"
...
static void handler(int sig, siginfo_t *si, void *uc)
{
 ...
 timer_info = si->
# 7 "src/main/drivers/timer_setup.c" 3 4
                 _sifields._rt.si_sigval
# 7 "src/main/drivers/timer_setup.c"
                         .sival_ptr;
...
# 15 "src/main/drivers/timer_setup.c"
                         ;
 sa->
# 16 "src/main/drivers/timer_setup.c" 3 4
    __sigaction_handler.sa_sigaction 
# 16 "src/main/drivers/timer_setup.c"
                 = handler;
...
# 19 "src/main/drivers/timer_setup.c" 3 4
 1
# 19 "src/main/drivers/timer_setup.c"
 ); } while (0);
}
...
# 25 "src/main/drivers/timer_setup.c"
                                ;
 sev->sigev_signo = 
# 26 "src/main/drivers/timer_setup.c" 3 4
                   (__libc_current_sigrtmin ())
# 26 "src/main/drivers/timer_setup.c"
                      ;
...
# 29 "src/main/drivers/timer_setup.c" 3 4
 1
# 29 "src/main/drivers/timer_setup.c"
 ); } while (0);
...
# 59 "src/main/drivers/timer_setup.c" 3 4
  1
# 59 "src/main/drivers/timer_setup.c"
  ); } while (0);
 }
...
# 62 "src/main/drivers/timer_setup.c" 3 4
  1
# 62 "src/main/drivers/timer_setup.c"
  ); } while (0);
}
