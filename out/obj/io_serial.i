...
# 29 "./src/main/drivers/serial_uart.h"
...
serialPortConfig_t *findNextSerialPortConfig(uint16_t mask)
{
    ...
    return 
# 152 "src/main/io/io_serial.c" 3 4
          ((void *)0)
# 152 "src/main/io/io_serial.c"
              ;
}
...
# 167 "src/main/io/io_serial.c" 3 4
_Bool 
# 167 "src/main/io/io_serial.c"
    isSerialPortShared(serialPortConfig_t *portConfig, uint16_t functionMask, serialPortFunction_e sharedWithFunction)
{
...
# 172 "src/main/io/io_serial.c" 3 4
_Bool 
# 172 "src/main/io/io_serial.c"
    isSerialPortOpen(serialPortConfig_t *portConfig)
{
...
serialPort_t *findNextSharedSerialPort(uint16_t functionMask, serialPortFunction_e sharedWithFunction)
{
    ...
    return 
# 201 "src/main/io/io_serial.c" 3 4
          ((void *)0)
# 201 "src/main/io/io_serial.c"
              ;
}
...
# 207 "src/main/io/io_serial.c" 3 4
_Bool 
# 207 "src/main/io/io_serial.c"
    isSerialConfigValid(serialConfig_t *serialConfigToCheck)
{
    ...
    for (index = 0; index < 2; index++) {
        ...
        if (bitCount > 1) {
            ...
            if (bitCount > 2) {
                return 
# 230 "src/main/io/io_serial.c" 3 4
                      0
# 230 "src/main/io/io_serial.c"
                           ;
            }

            if (!(portConfig->functionMask & FUNCTION_MSP_SERVER)) {
                return 
# 234 "src/main/io/io_serial.c" 3 4
                      0
# 234 "src/main/io/io_serial.c"
                           ;
            }
            ...
            if (!(portConfig->functionMask & (FUNCTION_BLACKBOX | (FUNCTION_TELEMETRY_FRSKY | FUNCTION_TELEMETRY_HOTT | FUNCTION_TELEMETRY_SMARTPORT | FUNCTION_TELEMETRY_LTM | FUNCTION_TELEMETRY_MAVLINK)))) {
                ...
                return 
# 239 "src/main/io/io_serial.c" 3 4
                      0
# 239 "src/main/io/io_serial.c"
                           ;
            }
        }
    }
    ...
    if (mspPortCount == 0 || mspPortCount > 2) {
        return 
# 245 "src/main/io/io_serial.c" 3 4
              0
# 245 "src/main/io/io_serial.c"
                   ;
    }
    return 
# 247 "src/main/io/io_serial.c" 3 4
          1
# 247 "src/main/io/io_serial.c"
              ;
}
...
serialPortConfig_t *serialFindPortConfiguration(serialPortIdentifier_e identifier)
{
    ...
    return 
# 259 "src/main/io/io_serial.c" 3 4
          ((void *)0)
# 259 "src/main/io/io_serial.c"
              ;
}


# 262 "src/main/io/io_serial.c" 3 4
_Bool 
# 262 "src/main/io/io_serial.c"
    doesConfigurationUsePort(serialPortIdentifier_e identifier)
{
    ...
    return candidate != 
# 265 "src/main/io/io_serial.c" 3 4
                       ((void *)0) 
# 265 "src/main/io/io_serial.c"
    ...
    portOptions_t options)
{
    ...
    if (!serialPortUsage || serialPortUsage->function != FUNCTION_NONE) {
        ...
        return 
# 286 "src/main/io/io_serial.c" 3 4
              ((void *)0)
# 286 "src/main/io/io_serial.c"
                  ;
    }

    serialPort_t *serialPort = 
# 289 "src/main/io/io_serial.c" 3 4
                              ((void *)0)
# 289 "src/main/io/io_serial.c"
                                  ;
...
# 334 "src/main/io/io_serial.c"
    ...
    if (!serialPort) {
        return 
# 339 "src/main/io/io_serial.c" 3 4
              ((void *)0)
# 339 "src/main/io/io_serial.c"
                  ;
    }
...
void closeSerialPort(serialPort_t *serialPort)
{
    ...
    serialPort->callback = 
# 361 "src/main/io/io_serial.c" 3 4
                          ((void *)0)
# 361 "src/main/io/io_serial.c"
                              ;

    serialPortUsage->function = FUNCTION_NONE;
    serialPortUsage->serialPort = 
# 364 "src/main/io/io_serial.c" 3 4
                                 ((void *)0)
# 364 "src/main/io/io_serial.c"
                                     ;
}

void serialInit(
# 367 "src/main/io/io_serial.c" 3 4
               _Bool 
# 367 "src/main/io/io_serial.c"
                    softserialEnabled)
{
    uint8_t index;
...
# 409 "src/main/io/io_serial.c" 3 4
_Bool 
# 409 "src/main/io/io_serial.c"
    serialIsPortAvailable(serialPortIdentifier_e identifier)
{
    for (uint8_t index = 0; index < 2; index++) {
        if (serialPortUsageList[index].identifier == identifier) {
...
# 413 "src/main/io/io_serial.c"
    ...
    return 
# 416 "src/main/io/io_serial.c" 3 4
          0
# 416 "src/main/io/io_serial.c"
               ;
}
