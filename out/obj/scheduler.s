...
.LFB0:
	...
	.loc 1 57 0
	movl	taskQueueArraySize(%rip), %eax	# taskQueueArraySize, D.3011
	movl	%eax, %eax	# D.3011, D.3012
	salq	$3, %rax	#, D.3012
	movq	%rax, %rdx	# D.3012,
	movl	$0, %esi	#,
...
.L6:
	...
	movq	taskQueueArray(,%rax,8), %rax	# taskQueueArray, D.3015
	cmpq	-24(%rbp), %rax	# task, D.3015
	jne	.L4	#,
	.loc 1 73 0
	movl	$1, %eax	#, D.3013
	jmp	.L5	#
...
.L3:
	...
	movl	taskQueueSize(%rip), %eax	# taskQueueSize, D.3014
	cmpl	%eax, -4(%rbp)	# D.3014, ii
	jb	.L6	#,
.LBE2:
...
.LFB2:
	...
	movq	%rdi, -24(%rbp)	# task, task
	.loc 1 81 0
	movl	taskQueueSize(%rip), %edx	# taskQueueSize, D.3017
	movl	taskCount(%rip), %eax	# taskCount, D.3017
	cmpl	%eax, %edx	# D.3017, D.3017
	jnb	.L8	#,
...
.L14:
	...
	movq	taskQueueArray(,%rax,8), %rax	# taskQueueArray, D.3018
	testq	%rax, %rax	# D.3018
	je	.L12	#,
	.loc 1 85 0 discriminator 1
	movl	-4(%rbp), %eax	# ii, tmp108
	movq	taskQueueArray(,%rax,8), %rax	# taskQueueArray, D.3018
	movzbl	28(%rax), %edx	# _14->staticPriority, D.3019
	movq	-24(%rbp), %rax	# task, tmp109
	movzbl	28(%rax), %eax	# task_8(D)->staticPriority, D.3019
	cmpb	%al, %dl	# D.3019, D.3019
	jnb	.L13	#,
.L12:
	.loc 1 86 0
	movl	taskQueueSize(%rip), %eax	# taskQueueSize, D.3017
	subl	-4(%rbp), %eax	# ii, D.3017
	movl	%eax, %eax	# D.3017, D.3020
	leaq	0(,%rax,8), %rdx	#, D.3020
	movl	-4(%rbp), %eax	# ii, tmp110
	salq	$3, %rax	#, tmp111
	leaq	taskQueueArray(%rax), %rcx	#, D.3021
	movl	-4(%rbp), %eax	# ii, tmp112
	addl	$1, %eax	#, D.3017
	movl	%eax, %eax	# D.3017, tmp113
	salq	$3, %rax	#, tmp114
	addq	$taskQueueArray, %rax	#, D.3021
	movq	%rcx, %rsi	# D.3021,
	movq	%rax, %rdi	# D.3021,
	call	memmove	#
	.loc 1 87 0
	...
	movl	taskQueueSize(%rip), %eax	# taskQueueSize, D.3017
	addl	$1, %eax	#, D.3017
	movl	%eax, taskQueueSize(%rip)	# D.3017, taskQueueSize
	.loc 1 89 0
	movl	$1, %eax	#, D.3016
	jmp	.L10	#
.L13:
...
.L19:
	...
	movq	taskQueueArray(,%rax,8), %rax	# taskQueueArray, D.3024
	cmpq	-24(%rbp), %rax	# task, D.3024
	jne	.L17	#,
	.loc 1 99 0
	movl	taskQueueSize(%rip), %eax	# taskQueueSize, D.3023
	subl	-4(%rbp), %eax	# ii, D.3023
	movl	%eax, %eax	# D.3023, D.3025
	leaq	0(,%rax,8), %rdx	#, D.3025
	movl	-4(%rbp), %eax	# ii, tmp101
	addl	$1, %eax	#, D.3023
	movl	%eax, %eax	# D.3023, tmp102
	salq	$3, %rax	#, tmp103
	leaq	taskQueueArray(%rax), %rcx	#, D.3026
	movl	-4(%rbp), %eax	# ii, tmp104
	salq	$3, %rax	#, tmp105
	addq	$taskQueueArray, %rax	#, D.3026
	movq	%rcx, %rsi	# D.3026,
	movq	%rax, %rdi	# D.3026,
	call	memmove	#
	.loc 1 100 0
	movl	taskQueueSize(%rip), %eax	# taskQueueSize, D.3023
	subl	$1, %eax	#, D.3023
	movl	%eax, taskQueueSize(%rip)	# D.3023, taskQueueSize
	.loc 1 101 0
	movl	$1, %eax	#, D.3022
	jmp	.L18	#
.L17:
...
.LFB4:
	...
	movl	$0, taskQueuePos(%rip)	#, taskQueuePos
	.loc 1 113 0
	movq	taskQueueArray(%rip), %rax	# taskQueueArray, D.3027
	.loc 1 114 0
	popq	%rbp	#
	.cfi_def_cfa 7, 8
	ret
...
.LFB5:
	...
	.cfi_def_cfa_register 6
	.loc 1 121 0
	movl	taskQueuePos(%rip), %eax	# taskQueuePos, D.3028
	addl	$1, %eax	#, D.3028
	movl	%eax, taskQueuePos(%rip)	# D.3028, taskQueuePos
	movl	taskQueuePos(%rip), %eax	# taskQueuePos, D.3028
	cltq
	movq	taskQueueArray(,%rax,8), %rax	# taskQueueArray, D.3029
	.loc 1 122 0
	popq	%rbp	#
	.cfi_def_cfa 7, 8
	ret
...
.LFB6:
	...
	subq	$16, %rsp	#,
	.loc 1 128 0
	movl	totalWaitingTasksSamples(%rip), %eax	# totalWaitingTasksSamples, D.3030
	testl	%eax, %eax	# D.3030
	je	.L25	#,
	.loc 1 129 0
	movl	totalWaitingTasks(%rip), %eax	# totalWaitingTasks, D.3030
	imull	$100, %eax, %eax	#, D.3030, D.3030
	movl	totalWaitingTasksSamples(%rip), %ecx	# totalWaitingTasksSamples, D.3030
	movl	$0, %edx	#, tmp100
	divl	%ecx	# D.3030
	movw	%ax, averageSystemLoadPercent(%rip)	# D.3031, averageSystemLoadPercent
	.loc 1 130 0
...
.L28:
	...
	movzbl	28(%rax), %eax	# task_3->staticPriority, D.3032
	cmpb	$6, %al	#, D.3032
	je	.L27	#,
	.loc 1 138 0
	movq	-8(%rbp), %rax	# task, tmp103
	movl	44(%rax), %edx	# task_3->averageExecutionTime, D.3030
	movl	-12(%rbp), %eax	# maxNonRealtimeTaskTime, tmp105
	cmpl	%eax, %edx	# tmp105, D.3030
	cmovnb	%edx, %eax	# D.3030,, tmp104
...
.LBE5:
	.loc 1 142 0
	movl	-12(%rbp), %eax	# maxNonRealtimeTaskTime, D.3033
	movl	$300, %edx	#,
	movl	$10, %esi	#,
	movl	%eax, %edi	# D.3033,
	call	constrain	#
	addl	$25, %eax	#, D.3033
	movl	%eax, realtimeGuardInterval(%rip)	# D.3030, realtimeGuardInterval
	.loc 1 146 0
	nop
	leave
	.cfi_def_cfa 7, 8
...
.LFB7:
	...
	movq	(%rax), %rdx	# cfTasks[taskId_2(D)].taskName, D.3034
	movq	-16(%rbp), %rax	# taskInfo, tmp100
	movq	%rdx, (%rax)	# D.3034, taskInfo_4(D)->taskName
	.loc 1 152 0
	movl	-4(%rbp), %eax	# taskId, tmp102
	cltq
	salq	$6, %rax	#, tmp103
	addq	$cfTasks, %rax	#, D.3035
	movq	%rax, %rdi	# D.3035,
	call	queueContains	#
	movl	%eax, %edx	#, D.3036
	movq	-16(%rbp), %rax	# taskInfo, tmp104
	movb	%dl, 8(%rax)	# D.3036, taskInfo_4(D)->isEnabled
	.loc 1 153 0
	movl	-4(%rbp), %eax	# taskId, tmp106
	cltq
	salq	$6, %rax	#, tmp107
	addq	$cfTasks+24, %rax	#, tmp108
	movl	(%rax), %edx	# cfTasks[taskId_2(D)].desiredPeriod, D.3037
	movq	-16(%rbp), %rax	# taskInfo, tmp109
	movl	%edx, 12(%rax)	# D.3037, taskInfo_4(D)->desiredPeriod
	.loc 1 154 0
	movl	-4(%rbp), %eax	# taskId, tmp111
	cltq
	salq	$6, %rax	#, tmp112
	addq	$cfTasks+28, %rax	#, tmp113
	movzbl	(%rax), %edx	# cfTasks[taskId_2(D)].staticPriority, D.3038
	movq	-16(%rbp), %rax	# taskInfo, tmp114
	movb	%dl, 16(%rax)	# D.3038, taskInfo_4(D)->staticPriority
	.loc 1 155 0
	movl	-4(%rbp), %eax	# taskId, tmp116
	cltq
	salq	$6, %rax	#, tmp117
	addq	$cfTasks+52, %rax	#, tmp118
	movl	(%rax), %edx	# cfTasks[taskId_2(D)].maxExecutionTime, D.3037
	movq	-16(%rbp), %rax	# taskInfo, tmp119
	movl	%edx, 20(%rax)	# D.3037, taskInfo_4(D)->maxExecutionTime
	.loc 1 156 0
	movl	-4(%rbp), %eax	# taskId, tmp121
	cltq
	salq	$6, %rax	#, tmp122
	addq	$cfTasks+56, %rax	#, tmp123
	movl	(%rax), %edx	# cfTasks[taskId_2(D)].totalExecutionTime, D.3037
	movq	-16(%rbp), %rax	# taskInfo, tmp124
	movl	%edx, 24(%rax)	# D.3037, taskInfo_4(D)->totalExecutionTime
	.loc 1 157 0
	movl	-4(%rbp), %eax	# taskId, tmp126
	cltq
	salq	$6, %rax	#, tmp127
	addq	$cfTasks+44, %rax	#, tmp128
	movl	(%rax), %edx	# cfTasks[taskId_2(D)].averageExecutionTime, D.3037
	movq	-16(%rbp), %rax	# taskInfo, tmp129
	movl	%edx, 28(%rax)	# D.3037, taskInfo_4(D)->averageExecutionTime
	.loc 1 158 0
	movl	-4(%rbp), %eax	# taskId, tmp131
	cltq
	salq	$6, %rax	#, tmp132
	addq	$cfTasks+48, %rax	#, tmp133
	movl	(%rax), %edx	# cfTasks[taskId_2(D)].taskLatestDeltaTime, D.3037
	movq	-16(%rbp), %rax	# taskInfo, tmp134
	movl	%edx, 32(%rax)	# D.3037, taskInfo_4(D)->latestDeltaTime
	.loc 1 159 0
	nop
	leave
	.cfi_def_cfa 7, 8
...
.LFB8:
	...
	movl	taskCount(%rip), %eax	# taskCount, D.3040
	cmpl	%eax, -20(%rbp)	# D.3041, taskId
	jge	.L35	#,
.L31:
.LBB6:
	...
	cltq
	salq	$6, %rax	#, tmp93
	addq	$cfTasks, %rax	#, D.3039
	jmp	.L34	#
.L33:
	.loc 1 165 0 discriminator 2
	movq	currentTask(%rip), %rax	# currentTask, D.3039
.L34:
	.loc 1 165 0 discriminator 4
	movq	%rax, -8(%rbp)	# D.3039, task
	.loc 1 166 0 is_stmt 1 discriminator 4
	movl	$100, %eax	#, tmp94
	cmpl	$100, -24(%rbp)	#, newPeriodMicros
	cmovnb	-24(%rbp), %eax	# newPeriodMicros,, D.3040
	movl	%eax, %edx	# D.3040, D.3040
	movq	-8(%rbp), %rax	# task, tmp95
	movl	%edx, 24(%rax)	# D.3040, task_9->desiredPeriod
.L35:
.LBE6:
	.loc 1 168 0
	nop
...
.LFB9:
	...
	subq	$32, %rsp	#,
	movl	%edi, -20(%rbp)	# taskId, taskId
	movl	%esi, %eax	# enabled, tmp92
	movb	%al, -24(%rbp)	# tmp92, enabled
	.loc 1 172 0
	movl	-20(%rbp), %eax	# taskId, tmp94
	cltq
	salq	$6, %rax	#, tmp95
	addq	$cfTasks, %rax	#, tmp96
	movq	(%rax), %rax	# cfTasks[taskId_4(D)].taskName, D.3043
	movq	%rax, %rdi	# D.3043,
	call	puts	#
	.loc 1 173 0
	cmpl	$-1, -20(%rbp)	#, taskId
	...
	movl	taskCount(%rip), %eax	# taskCount, D.3044
	cmpl	%eax, -20(%rbp)	# D.3045, taskId
	jge	.L42	#,
.L37:
.LBB7:
	...
	movl	-20(%rbp), %eax	# taskId, tmp98
	cltq
	salq	$6, %rax	#, tmp99
	addq	$cfTasks, %rax	#, D.3042
	jmp	.L40	#
.L39:
	.loc 1 174 0 discriminator 2
	movq	currentTask(%rip), %rax	# currentTask, D.3042
.L40:
	.loc 1 174 0 discriminator 4
	movq	%rax, -8(%rbp)	# D.3042, task
	.loc 1 175 0 is_stmt 1 discriminator 4
	cmpb	$0, -24(%rbp)	#, enabled
	je	.L41	#,
	.loc 1 175 0 is_stmt 0 discriminator 1
	movq	-8(%rbp), %rax	# task, tmp100
	movq	16(%rax), %rax	# task_11->taskFunc, D.3046
	testq	%rax, %rax	# D.3046
	je	.L41	#,
	.loc 1 176 0 is_stmt 1
	movq	-8(%rbp), %rax	# task, tmp101
	movq	%rax, %rdi	# tmp101,
	call	queueAdd	#
.LBE7:
	.loc 1 181 0
...
.LFB10:
	...
	movl	taskCount(%rip), %eax	# taskCount, D.3049
	cmpl	%eax, -20(%rbp)	# D.3050, taskId
	jge	.L45	#,
.L44:
.LBB9:
	...
	cltq
	salq	$6, %rax	#, tmp94
	addq	$cfTasks, %rax	#, D.3047
	jmp	.L47	#
.L46:
	.loc 1 186 0 discriminator 2
	movq	currentTask(%rip), %rax	# currentTask, D.3047
.L47:
	.loc 1 186 0 discriminator 4
	movq	%rax, -8(%rbp)	# D.3047, task
	.loc 1 187 0 is_stmt 1 discriminator 4
	movq	-8(%rbp), %rax	# task, tmp95
	movl	48(%rax), %eax	# task_10->taskLatestDeltaTime, D.3048
	jmp	.L48	#
.L45:
.LBE9:
	.loc 1 189 0
...
.LFB12:
	...
	.loc 1 202 0
	call	micros	#
	movl	%eax, currentTime(%rip)	# D.3053, currentTime
	.loc 1 203 0
	call	queueFirst	#
...
.LBB11:
	...
	movl	36(%rax), %edx	# task_3->lastExecutedAt, D.3053
	movq	-32(%rbp), %rax	# task, tmp163
	movl	24(%rax), %eax	# task_3->desiredPeriod, D.3053
	addl	%edx, %eax	# D.3053, tmp164
	movl	%eax, -48(%rbp)	# tmp164, nextExecuteAt
	.loc 1 208 0
	movl	currentTime(%rip), %eax	# currentTime, D.3053
	subl	-48(%rbp), %eax	# nextExecuteAt, D.3053
...
.L51:
	...
	movzbl	28(%rax), %eax	# task_3->staticPriority, D.3054
	cmpb	$5, %al	#, D.3054
	ja	.L55	#,
.L54:
.LBE10:
	.loc 1 215 0
	movl	realtimeGuardInterval(%rip), %eax	# realtimeGuardInterval, D.3053
	cmpl	%eax, -52(%rbp)	# D.3053, timeToNextRealtimeTask
	seta	%al	#, tmp173
...
.L66:
	...
	movq	8(%rax), %rax	# task_11->checkFunc, D.3055
	testq	%rax, %rax	# D.3055
	je	.L57	#,
	.loc 1 226 0
	movq	-16(%rbp), %rax	# task, tmp176
	movzwl	30(%rax), %eax	# task_11->dynamicPriority, D.3056
	testw	%ax, %ax	# D.3056
	je	.L58	#,
	.loc 1 227 0
	movl	currentTime(%rip), %edx	# currentTime, D.3053
	movq	-16(%rbp), %rax	# task, tmp177
	movl	40(%rax), %eax	# task_11->lastSignaledAt, D.3053
	movl	%edx, %ecx	# D.3053, D.3053
	subl	%eax, %ecx	# D.3053, D.3053
	movq	-16(%rbp), %rax	# task, tmp178
	movl	24(%rax), %esi	# task_11->desiredPeriod, D.3053
	movl	%ecx, %eax	# D.3053, tmp179
	movl	$0, %edx	#, tmp180
	divl	%esi	# D.3053
	leal	1(%rax), %edx	#, D.3056
	movq	-16(%rbp), %rax	# task, tmp181
	movw	%dx, 32(%rax)	# D.3056, task_11->taskAgeCycles
	.loc 1 228 0
	movq	-16(%rbp), %rax	# task, tmp182
	movzbl	28(%rax), %eax	# task_11->staticPriority, D.3054
	movzbl	%al, %edx	# D.3054, D.3056
	movq	-16(%rbp), %rax	# task, tmp183
	movzwl	32(%rax), %eax	# task_11->taskAgeCycles, D.3056
	imull	%edx, %eax	# D.3056, D.3056
	leal	1(%rax), %edx	#, D.3056
	movq	-16(%rbp), %rax	# task, tmp184
	movw	%dx, 30(%rax)	# D.3056, task_11->dynamicPriority
	.loc 1 229 0
	movzwl	-54(%rbp), %eax	# waitingTasks, D.3056
	addl	$1, %eax	#, tmp185
...
.L58:
	...
	movq	8(%rax), %rax	# task_11->checkFunc, D.3055
	movl	currentTime(%rip), %ecx	# currentTime, D.3053
	movq	-16(%rbp), %rdx	# task, tmp187
	movl	36(%rdx), %edx	# task_11->lastExecutedAt, D.3053
	subl	%edx, %ecx	# D.3053, D.3053
	movl	%ecx, %edx	# D.3053, D.3053
	movl	%edx, %edi	# D.3053,
	call	*%rax	# D.3055
	testb	%al, %al	# D.3057
	je	.L60	#,
	...
	movl	%edx, 40(%rax)	# D.3053, task_11->lastSignaledAt
	.loc 1 232 0
...
.L57:
	...
	movl	36(%rax), %eax	# task_11->lastExecutedAt, D.3053
	movl	%edx, %ecx	# D.3053, D.3053
	subl	%eax, %ecx	# D.3053, D.3053
	movq	-16(%rbp), %rax	# task, tmp195
	movl	24(%rax), %edi	# task_11->desiredPeriod, D.3053
	movl	%ecx, %eax	# D.3053, tmp196
	movl	$0, %edx	#, tmp197
	divl	%edi	# D.3053
	movl	%eax, %edx	# D.3053, D.3056
...
.L61:
	...
	movzwl	30(%rax), %eax	# task_11->dynamicPriority, D.3056
	cmpw	-56(%rbp), %ax	# selectedTaskDynamicPriority, D.3056
	jbe	.L62	#,
.LBB14:
	.loc 1 251 0
...
.L65:
	...
	movb	%al, -57(%rbp)	# D.3051, taskCanBeChosenForScheduling
...
.LBE13:
	.loc 1 259 0
	movl	totalWaitingTasksSamples(%rip), %eax	# totalWaitingTasksSamples, D.3053
	addl	$1, %eax	#, D.3053
	movl	%eax, totalWaitingTasksSamples(%rip)	# D.3053, totalWaitingTasksSamples
	.loc 1 260 0
	movzwl	-54(%rbp), %edx	# waitingTasks, D.3053
	movl	totalWaitingTasks(%rip), %eax	# totalWaitingTasks, D.3053
	addl	%edx, %eax	# D.3053, D.3053
	movl	%eax, totalWaitingTasks(%rip)	# D.3053, totalWaitingTasks
	.loc 1 262 0
...
.LBB15:
	...
	movl	36(%rax), %eax	# selectedTask_5->lastExecutedAt, D.3053
	subl	%eax, %edx	# D.3053, D.3053
	movq	-24(%rbp), %rax	# selectedTask, tmp213
	movl	%edx, 48(%rax)	# D.3053, selectedTask_5->taskLatestDeltaTime
	.loc 1 267 0
	movl	currentTime(%rip), %edx	# currentTime, D.3053
	movq	-24(%rbp), %rax	# selectedTask, tmp214
	movl	%edx, 36(%rax)	# D.3053, selectedTask_5->lastExecutedAt
	.loc 1 268 0
	movq	-24(%rbp), %rax	# selectedTask, tmp215
	movw	$0, 30(%rax)	#, selectedTask_5->dynamicPriority
	.loc 1 271 0
	call	micros	#
	movl	%eax, -40(%rbp)	# D.3052, currentTimeBeforeTaskCall
	.loc 1 272 0
	movq	-24(%rbp), %rax	# selectedTask, tmp216
	movq	16(%rax), %rax	# selectedTask_5->taskFunc, D.3058
	call	*%rax	# D.3058
	.loc 1 273 0
	call	micros	#
	...
	movl	44(%rax), %edx	# selectedTask_5->averageExecutionTime, D.3053
	movl	%edx, %eax	# D.3053, tmp220
	sall	$5, %eax	#, tmp221
	subl	%edx, %eax	# D.3053, D.3053
	movl	%eax, %edx	# D.3053, D.3053
	movl	-36(%rbp), %eax	# taskExecutionTime, tmp222
	addl	%edx, %eax	# D.3053, D.3053
	shrl	$5, %eax	#, D.3053
	movl	%eax, %edx	# D.3053, D.3053
	movq	-24(%rbp), %rax	# selectedTask, tmp223
	movl	%edx, 44(%rax)	# D.3053, selectedTask_5->averageExecutionTime
	.loc 1 277 0
	movq	-24(%rbp), %rax	# selectedTask, tmp224
	movl	56(%rax), %edx	# selectedTask_5->totalExecutionTime, D.3053
	movl	-36(%rbp), %eax	# taskExecutionTime, tmp225
	addl	%eax, %edx	# tmp225, D.3053
	movq	-24(%rbp), %rax	# selectedTask, tmp226
	movl	%edx, 56(%rax)	# D.3053, selectedTask_5->totalExecutionTime
	.loc 1 278 0
	movq	-24(%rbp), %rax	# selectedTask, tmp227
	movl	52(%rax), %edx	# selectedTask_5->maxExecutionTime, D.3053
	movl	-36(%rbp), %eax	# taskExecutionTime, tmp228
	cmpl	%eax, %edx	# tmp228, D.3053
	cmovb	%eax, %edx	# D.3053,, tmp228, D.3053
	movq	-24(%rbp), %rax	# selectedTask, tmp229
	movl	%edx, 52(%rax)	# D.3053, selectedTask_5->maxExecutionTime
.L68:
.LBE15:
	.loc 1 288 0
	nop
