...
static 
# 135 "src/main/fc/cleanflight_fc.c" 3 4
      _Bool 
# 135 "src/main/fc/cleanflight_fc.c"
           isRXDataNew;


# 137 "src/main/fc/cleanflight_fc.c" 3 4
_Bool 
# 137 "src/main/fc/cleanflight_fc.c"
    gyro_initialized = 
# 137 "src/main/fc/cleanflight_fc.c" 3 4
                       0
# 137 "src/main/fc/cleanflight_fc.c"
...
# 143 "src/main/fc/cleanflight_fc.c" 3 4
_Bool 
# 143 "src/main/fc/cleanflight_fc.c"
...
void taskHandleSerial(void)
{
# 162 "src/main/fc/cleanflight_fc.c"
    mspSerialProcess();
}
...
void taskMainPidLoopChecker(void)
{
    ...
    if(!gyro_initialized)
    {
        ...
        gyro_initialized = 
# 185 "src/main/fc/cleanflight_fc.c" 3 4
                          1
# 185 "src/main/fc/cleanflight_fc.c"
                              ;
    }
...
# 263 "src/main/fc/cleanflight_fc.c"
}
