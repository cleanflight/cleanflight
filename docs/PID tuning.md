...
On PID controllers 0 and 5, yaw rate acts as a PID reduction, just as for pitch and roll rates explained above. For PID controllers 1-4, it acts as a stick sensitivity multiplier, also working in the same way as above.