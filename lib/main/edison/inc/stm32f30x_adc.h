...
typedef struct
{
  ...
  mraa_aio_context ADC_Context_number;     //Specifies the pin number being used for the Analog in. Uses the mraa library for accessing the ADC pin

  uint8_t ADC_gpio_pin;                    //Analog pin number used as input pin for ADC
...
/** @defgroup ADC_resolution 
  * @{
  */ 
#define ADC_Resolution_12b                         12  /*!<  ADC 12-bit resolution */
#define ADC_Resolution_10b                         10  /*!<  ADC 10-bit resolution */
#define ADC_Resolution_8b                          8  /*!<  ADC 8-bit resolution */
#define ADC_Resolution_6b                          6  /*!<  ADC 6-bit resolution */
...
void ADC_Init(ADC_InitTypeDef* ADC_InitStruct)                          //Replaced above definition for the edison. no need for ADC_Typedef struct. Refer stm32f30x.h for that struct definition
