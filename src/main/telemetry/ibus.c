...
void initIbusTelemetry(void)
{
    ...
    if (type == 4) {
        ...
        if (sensors(SENSOR_PITOT)) {
            changeTypeIbusTelemetry(11, IBUS_MEAS_TYPE_VSPEED, IBUS_MEAS_VALUE_VSPEED);
        } else 
#endif
        {
...
#ifdef PITOT
        if (sensors(SENSOR_PITOT)) { 
            changeTypeIbusTelemetry(9,IBUS_MEAS_TYPE1_VERTICAL_SPEED, IBUS_MEAS_VALUE_VSPEED);
        } else 
#endif
        {
    ...
    if (type == 6 || type == 7) {
        if (batteryConfig()->currentMeterSource == CURRENT_METER_VIRTUAL) {
            ...
            changeTypeIbusTelemetry(3, IBUS_MEAS_TYPE1_BAT_CURR, IBUS_MEAS_VALUE_CURRENT);
        }
        ...
        if (speed) {
            changeTypeIbusTelemetry(10, IBUS_MEAS_TYPE1_GROUND_SPEED, IBUS_MEAS_VALUE_SPEED);
        } else {
            changeTypeIbusTelemetry(10, IBUS_MEAS_TYPE1_SPE, IBUS_MEAS_VALUE_SPE);
        }
