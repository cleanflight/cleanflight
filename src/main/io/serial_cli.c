...
const clivalue_t valueTable[] = {
    ...
    { "failsafe_abortable",         VAR_UINT8  | PROFILE_VALUE, &masterConfig.profile[0].failsafeConfig.failsafe_abortable, 0, 1 },
#if defined(BARO) || defined(SONAR)
    { "failsafe_use_altitude",      VAR_UINT8  | PROFILE_VALUE, &masterConfig.profile[0].failsafeConfig.failsafe_use_altitude, 0, 800 },
#endif
