...
PG_REGISTER_ARR_WITH_RESET(modeColorIndexes_t, MODE_COUNT, modeColors, PG_MODE_COLOR_CONFIG, 0);
PG_REGISTER_ARR_WITH_RESET(specialColorIndexes_t, 1, specialColors, PG_SPECIAL_COLOR_CONFIG, 0);
...
void pgReset_modeColors(modeColorIndexes_t *instance)
{
    memcpy(instance, &defaultModeColors, sizeof(defaultModeColors));
}

void pgReset_specialColors(specialColorIndexes_t *instance)
{
