...
#define TILT_ARM_ENABLE_PITCH_DIVIDER             (1<<0)
#define TILT_ARM_ENABLE_THRUST_COMPENSATION       (1<<1)
#define TILT_ARM_ENABLE_YAW_ROLL_COMPENSATION     (1<<2)
#define TILT_ARM_ENABLE_THRUST_BODY_COMPENSATION  (1<<3)
