...
#define PG_LEDSTRIP_LEDS_CONFIG 27
#define PG_LEDSTRIP_PALETTE 28
...
#define PG_LEDSTRIP_MODE_COLOR_CONFIG 45
#define PG_LEDSTRIP_SPECIAL_COLOR_CONFIG 46
