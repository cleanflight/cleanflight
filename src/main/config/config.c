...
static void resetConf(void)
{
    ...
    currentProfile->failsafeConfig.failsafe_use_altitude = 0;        // 0: failsafe does not use altitude info, > 0: failsafe disarms at 'failsafe_use_altitude' cm above groundlevel
#endif
