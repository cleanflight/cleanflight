...
static void resetConf(void)
{
    ...
    currentProfile->throttle_hovering_percent = 0;      // 0= disabled, max value 100%
    currentProfile->throttle_compensation_axis = 0;     // witch axis should be compensated, based on enum angle_index_t on axis.h
