...
#define SERIALUART3_TXDMA_IRQ_PRIORITY        1
#define SERIALUART3_TXDMA_IRQ_SUBPRIORITY     0

#define SERIALUART3_RXDMA_IRQ_PRIORITY        1
#define SERIALUART3_RXDMA_IRQ_SUBPRIORITY     1
