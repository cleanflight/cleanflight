...
static const uint16_t multiPPM[] = {
    PWM1  | (MAP_TO_PPM_INPUT << 8),     // PPM input - naze TIM2
    PWM9  | (MAP_TO_MOTOR_OUTPUT << 8),  // Swap to servo if needed - naze TIM1
    PWM10 | (MAP_TO_MOTOR_OUTPUT << 8),  // Swap to servo if needed - naze TIM1
    PWM11 | (MAP_TO_MOTOR_OUTPUT << 8),  // naze TIM4
    PWM12 | (MAP_TO_MOTOR_OUTPUT << 8),  // naze TIM4
    PWM13 | (MAP_TO_MOTOR_OUTPUT << 8),  // naze TIM4
    PWM14 | (MAP_TO_MOTOR_OUTPUT << 8),  // naze TIM4
    PWM5  | (MAP_TO_MOTOR_OUTPUT << 8),  // Swap to servo if needed - naze TIM3
    PWM6  | (MAP_TO_MOTOR_OUTPUT << 8),  // Swap to servo if needed - naze TIM3
    PWM7  | (MAP_TO_MOTOR_OUTPUT << 8),  // Swap to servo if needed - naze TIM3
    PWM8  | (MAP_TO_MOTOR_OUTPUT << 8),  // Swap to servo if needed - naze TIM3
    0xFFFF
};

static const uint16_t multiPWM[] = {
    PWM1  | (MAP_TO_PWM_INPUT << 8),     // input #1 - naze TIM2
    PWM2  | (MAP_TO_PWM_INPUT << 8),	 // naze TIM2
    PWM3  | (MAP_TO_PWM_INPUT << 8),	 // naze TIM2
    PWM4  | (MAP_TO_PWM_INPUT << 8),     // naze TIM2
    PWM5  | (MAP_TO_PWM_INPUT << 8),     // naze TIM3
    PWM6  | (MAP_TO_PWM_INPUT << 8),     // naze TIM3
    PWM7  | (MAP_TO_PWM_INPUT << 8),     // naze TIM3
    PWM8  | (MAP_TO_PWM_INPUT << 8),     // input #8 -naze TIM3
    PWM9  | (MAP_TO_MOTOR_OUTPUT  << 8),      // motor #1 or servo #1 (swap to servo if needed) -  naze TIM1
    PWM10 | (MAP_TO_MOTOR_OUTPUT  << 8),     // motor #2 or servo #2 (swap to servo if needed) -  naze TIM1
    PWM11 | (MAP_TO_MOTOR_OUTPUT  << 8),     // motor #1 or #3 -  naze TIM4
    PWM12 | (MAP_TO_MOTOR_OUTPUT  << 8),     // naze TIM4
    PWM13 | (MAP_TO_MOTOR_OUTPUT  << 8),     // naze TIM4
    PWM14 | (MAP_TO_MOTOR_OUTPUT  << 8),     // motor #4 or #6 - naze TIM4
    0xFFFF
};
