...
#define TARGET_BOARD_IDENTIFIER "MFBC" // MultiFlite Nano Brushed FC
...
#define MFBC_SPI_INSTANCE     SPI2
#define MFBC_SPI_CS_GPIO      GPIOB
#define MFBC_SPI_CS_PIN       GPIO_Pin_12

#define M25P16_CS_GPIO        MFBC_SPI_CS_GPIO
#define M25P16_CS_PIN         MFBC_SPI_CS_PIN
#define M25P16_SPI_INSTANCE   MFBC_SPI_INSTANCE
