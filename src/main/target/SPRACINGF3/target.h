...
#define SOFTSERIAL_1_TIMER_RX_HARDWARE 4 // RC_CH 5
#define SOFTSERIAL_1_TIMER_TX_HARDWARE 5 // RC_CH 6
#define SOFTSERIAL_2_TIMER TIM3
#define SOFTSERIAL_2_TIMER_RX_HARDWARE 6 // RC_CH 7
#define SOFTSERIAL_2_TIMER_TX_HARDWARE 7 // RC_CH 8
