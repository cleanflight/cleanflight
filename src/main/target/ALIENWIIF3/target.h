...
/* Peripheral defines */
#define GYRO
#define USE_GYRO_MPU6050 // Using MPU6050 for the moment.
...
//#define BARO // No baro support.
//#define USE_BARO_MS5611

//#define MAG // No mag support for now (option to use MPU9150 in the future).
...
#define BINDPLUG_PIN   Pin_12 // Hardware bind plug at PB12 (Pin 25)


#define ALIENWII32 // alternative defaults for AlienWii32 F3 target
