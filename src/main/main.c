...
void init(void)
{
    ...
    if (!sensorsAutodetect(&masterConfig.sensorAlignmentConfig, currentProfile->pidProfile.gyro_lpf, masterConfig.acc_hardware, masterConfig.mag_hardware, currentProfile->mag_declination)) {
